...
class Service5Controller extends Controller
{
    ...
    public function setUser(){
      ...
      {
          $service = Service5::findOrFail($id);


          $page_title ="Edit Tender Detail";
          return view('services.5', compact('service','page_title'));
      }
      ...
      public function update(Request $request, $id)
      {
          ...
          if(isset($upate)) {
              return redirect('admin/service5/1/edit')->with('message','successfully Updated.');
          }else{
              return redirect()->route('admin/service5/1/edit')->with('message','Action Failed Please try again.');
          }
      }
