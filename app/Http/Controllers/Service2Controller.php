...
class Service2Controller extends Controller
{
    ...
    public function setUser(){
      ...
      {
          $service = Service2::findOrFail($id);


          $page_title ="Edit Tender Detail";
          return view('services.2', compact('service','page_title'));
      }
      ...
      public function update(Request $request, $id)
      {
          ...
          if(isset($upate)) {
              return redirect('admin/service2/1/edit')->with('message','successfully Updated.');
          }else{
