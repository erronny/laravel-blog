...
class Service10Controller extends Controller
{
    ...
    public function setUser(){
      ...
      {
          $service = Service10::findOrFail($id);


          $page_title ="Edit Tender Detail";
          return view('services.10', compact('service','page_title'));
      }
      ...
      public function update(Request $request, $id)
      {
          ...
          if(isset($upate)) {
              return redirect('admin/service10/1/edit')->with('message','successfully Updated.');
          }else{
              return redirect()->route('admin/service10/1/edit')->with('message','Action Failed Please try again.');
          }
      }
