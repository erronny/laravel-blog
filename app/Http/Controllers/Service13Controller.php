...
class Service13Controller extends Controller
{
    ...
    public function setUser(){
      ...
      {
          $service = Service13::findOrFail($id);


          $page_title ="Edit Tender Detail";
          return view('services.13', compact('service','page_title'));
      }
      ...
      public function update(Request $request, $id)
      {
          ...
          if(isset($upate)) {
              return redirect('admin/service13/1/edit')->with('message','successfully Updated.');
          }else{
              return redirect()->route('admin/service13/1/edit')->with('message','Action Failed Please try again.');
          }
      }
