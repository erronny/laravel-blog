...
class Service6Controller extends Controller
{
    ...
    public function setUser(){
      ...
      {
          $service = Service6::findOrFail($id);


          $page_title ="Edit Tender Detail";
          return view('services.6', compact('service','page_title'));
      }
      ...
      public function update(Request $request, $id)
      {
          ...
          if(isset($upate)) {
              return redirect('admin/service6/1/edit')->with('message','successfully Updated.');
          }else{
              return redirect()->route('admin/service6/1/edit')->with('message','Action Failed Please try again.');
          }
      }
