...
<section id="team" class="light-bg">
  <h2 class="text text-center">{{ $title?$title:'Forgot Password' }}</h2>
  <div class="container">
    <div class="row">
...
@endif
      @if(!$IsVerifyFlag)
     <form autocomplete="off" method="POST" action="{{ URL('verify_user') }}">
        {{ csrf_field() }}
        {{ $email }}
     ...
     @else
     <p class="alert alert-success">Your Email Aleady Verify</p>
     @endif
