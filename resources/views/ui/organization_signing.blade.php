...
@section('title', 'Organization Signing | Digital In-Corporation')
@section('description', '')
      ...
      <div class="container">
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-12 col-md-5">
            ...
            <!-- Link -->
            <a class="font-weight-bold text-decoration-none" href="{{ $service->d22 }}">
      ...
      <div class="container py-6 py-md-8 border-top border-bottom border-gray-900-50">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-auto">
            ...
            <!-- Button -->
            <a href="{{ $service->d43 }}" class="btn btn-primary lift">
              {{ $service->d42 }}
            </a>
