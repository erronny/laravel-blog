          ...
          <div class="col-12 col-lg-12 col-xl-11">
            ...
            <figure class="figure mb-0">
              ...
              <div class="figure-img" data-flickity='{"wrapAround": true, "pageDots": false, "imagesLoaded": true, "adaptiveHeight": true}'>
                <div class="w-100">
                  <img src="{{asset ('assets/ui/img/portfolio/portfolio-cover-3.jpg')}}" alt="..." class="img-fluid rounded" />
                </div>
                <div class="w-100">
                  <img src="{{asset ('assets/ui/img/portfolio/portfolio-cover-4.jpg')}}" alt="..." class="img-fluid rounded" />
                </div>
                <div class="w-100">
                  <img src="{{asset ('assets/ui/img/portfolio/portfolio-cover-5.jpg')}}" alt="..." class="img-fluid rounded" />
                </div>
              </div>
