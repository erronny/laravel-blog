      ...
      <div class="container">
        <div class="row align-items-center text-center text-md-left">
          <div class="col-12 col-md-6">
            ...
            <!-- Image -->
            <img src="{{asset ('assets/ui/img/illustrations/illustration-4.png')}}" alt="..." class="img-fluid mw-130 float-right mb-6 mb-md-0" data-aos="fade-right">
          ...
          <div class="col-12 col-md-6">
            ...
            <h1 class="display-1 font-weight-bold">
              <div data-aos="fade-left">{{ $service->d }}</div>
              <div data-aos="fade-left" data-aos-delay="100">{{ $service->d1 }}</div>
            </h1>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #FF5A5F;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="{{ $service->d21 }}" style="color: #FF5A5F;">{{ $service->d20 }}</a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #B81D24;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="{{ $service->d24 }}" style="color: #B81D24;">{{ $service->d23 }}</a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #0081C9;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="{{ $service->d27 }}" style="color: #0081C9;">R{{ $service->d26 }}</a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #6772E5;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="{{ $service->d30 }}" style="color: #6772E5;">{{ $service->d29 }}</a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #CB2027;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="{{ $service->d33 }}" style="color: #CB2027;">{{ $service->d32 }}</a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #DA5988;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="{{ $service->d36 }}" style="color: #DA5988;">{{ $service->d35 }}</a>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6">
            ...
            <a href="#!" class="btn btn-primary-desat mb-6 mb-md-0 lift">
              {{ $service->d39 }} <i class="fe fe-arrow-right ml-3"></i>
            </a>
        ...
        <div class="row">
          <div class="col-12 col-md-4 text-center">
            ...
            <h1 class="display-2 font-weight-bold text-primary-desat">
              <span data-toggle="countup" data-from="0" data-to="97" data-aos data-aos-id="countup:in">0</span>%
            </h1>
          ...
          <div class="col-12 col-md-4 text-center">
            ...
            <!-- Heading -->
            <h1 class="display-2 font-weight-bold text-primary-desat">
              <span data-toggle="countup" data-from="00.0" data-to="99.9" data-decimals="1" data-aos data-aos-id="countup:in">00.0</span>%
            </h1>
          ...
          <div class="col-12 col-md-4 text-center">
            ...
            <!-- Heading -->
            <h1 class="display-2 font-weight-bold text-primary-desat">
              <span data-toggle="countup" data-from="0.0" data-to="5.0" data-decimals="1" data-aos data-aos-id="countup:in">0.0</span>/5.0
            </h1>
