<!-- NAVBAR
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-white">
      <div class="container">
        ...
        <a class="navbar-brand" href="{{URL('/')}}">
          <img src="{{asset ('assets/logo/dic.png')}}" class="navbar-brand-img" alt="Digital In-Corporation Logo">
        </a>
              ...
              <div class="dropdown-menu dropdown-menu-xl p-0" aria-labelledby="navbarLandings">
                <div class="row no-gutters">
                  <div class="col-12 col-lg-4">
                    <div class="dropdown-img-left" style="background-image: url(assets/ui/img/header_image.jpg);">
                      ...
                      <!-- Button -->
                      <a href="{{URL('/')}}" class="btn btn-sm btn-white shadow-dark fonFt-size-sm">
                        View all pages
                      </a>
                    ...
                    <div class="dropdown-body">
                      <div class="row no-gutters">
                        <div class="col-6">
                          ...
                          <!-- List -->
                          <a class="dropdown-item" href="{{URL('/class2-invidual-signing')}}">
                            Individual Signing
                          </a>
                          <a class="dropdown-item" href="{{URL('/class2-invidual-combo')}}">
                            Individual Combo
                          </a>
                          <a class="dropdown-item mb-5" href="{{URL('/class2-organization-combo')}}">
                            Organization Combo
                          </a>
                          <a class="dropdown-item" href="{{URL('/class2-organization-signing')}}">
                            Organization Signing
                          </a>
                          <a class="dropdown-item" href="{{URL('/class2-document-signer')}}">
                            Document Signer
                          </a>
                          <a class="dropdown-item" href="{{URL('/class2-foreign-signing')}}">
                            Foreign Signing
                          </a>
                        ...
                        <div class="col-6">
                          ...
                          <!-- List -->
                          <a class="dropdown-item" href="{{URL('/class3-invidual-signing')}}">
                            Individual Signing
                          </a>
                          <a class="dropdown-item" href="{{URL('/class3-invidual-combo')}}">
                            Individual Combo
                          </a>
                          <a class="dropdown-item mb-5" href="{{URL('/class3-organization-combo')}}">
                            Organization Combo
                          </a>
                          <a class="dropdown-item" href="{{URL('/class3-organization-signing')}}">
                            Organization Signing
                          </a>
                          <a class="dropdown-item" href="{{URL('/class3-document-signer')}}">
                            Document Signer
                          </a>
                          <a class="dropdown-item" href="{{URL('/class3-foreign-signing')}}">
                            Foreign Signing
                          </a>
                  ...
                  <div class="col-6">
                    <div class="row no-gutters">
                     <!--  <div class="col-12 col-lg-6">
                        ...
                        <a class="dropdown-item mb-5" href="{{URL('/service2')}}">
                          Service2
                        </a>
                        ...
                        <a class="dropdown-item mb-5 mb-lg-0" href="{{URL('/service5')}}">
                          Service5
                        </a>
                      ...
                      <!-- <div class="col-12 col-lg-6">
                        ...
                        <a class="dropdown-item" href="{{URL('/service6')}}">
                          Service6
                        </a>
                        <a class="dropdown-item mb-5" href="{{URL('/service7')}}">
                          Service6
                        </a>
                  ...
                  <div class="col-6">
                    <div class="row no-gutters">
                      ...
                      <div class="col-12 col-lg-8">
                        ...
                        <!-- List -->
                        <a class="dropdown-item" href="{{URL('/e-tender')}}">
                          E-Tenders
                        </a>
                        <a class="dropdown-item" href="{{URL('/dgft')}}">
                          DGFT 
                        </a>
                        <a class="dropdown-item" href="{{URL('/')}}">
                          Foreign Trade
                        </a>
                        <a class="dropdown-item" href="{{URL('/gst')}}">
                          GST Registration
                        </a>
                        <a class="dropdown-item" href="{{URL('/')}}">
                          ICEGATE
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarAccount">
                <li class="dropdown-item dropright">
                  <a class="dropdown-link dropdown-toggle" data-toggle="dropdown" href="{{URL('/')}}">
                    Account
                  </a>
                ...
                <!-- <li class="dropdown-item dropright">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" data-toggle="modal" href="{{URL('/')}}">
                      Modal Horizontal
                    </a>
                    <a class="dropdown-item" data-toggle="modal" href="{{URL('/')}}">
                      Modal Vertical
 ...
 -->              </ul>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-md" aria-labelledby="navbarDocumentation">
                <div class="list-group list-group-flush">
                  <a class="list-group-item" href="{{URL('/post')}}">
          ...
          <!-- Button -->
          <a class="navbar-btn btn btn-sm btn-primary lift ml-auto" href="{{URL('/')}}" target="_blank">
            Buy now
          </a>
