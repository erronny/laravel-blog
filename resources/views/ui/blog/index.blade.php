...
@section('title', 'Digital In Corporation | Blog')
@section('description', '')
          ...
          <div class="col-12">
            ...
            <div class="card card-row shadow-light-lg mb-6 lift lift-lg">
              <div class="row no-gutters">
                ...
                <a class="col-12 col-md-6 order-md-2 bg-cover card-img-right" style="background-image: url({{ asset('assets/post/' .$post->image) }} );" href="{{ url("/Posts/{$post->slug}") }}">

                  <!-- Image (placeholder) -->
                  <img src="{{asset ('assets/post/' .$post->image )}}" alt="..." class="img-fluid d-md-none invisible">
                ...
                <div class="col-12 col-md-6 order-md-1">
                  ...
                  <a class="card-meta" href="#!">
                    ...
                    <div class="avatar avatar-sm mr-2">
                      <img src="{{asset ('assets/logo/favicon.png')}}" alt="..." class="avatar-img rounded-circle">
                    </div>
