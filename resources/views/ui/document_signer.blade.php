      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-6 order-md-1" data-aos="fade-up">
            ...
            <h1 class="display-3">
              {{ $service->d }} <br>
              <span class="text-primary">{{ $service->d1 }}</span>.
            </h1>
            ...
            <!-- Buttons -->
            <!-- <a href="{{ $service->d4 }}" class="btn btn-primary mr-1 lift">
              {{ $service->d3 }} <i class="fe fe-arrow-right ml-3"></i>
            </a>
            <a href="{{ $service->d6 }}" class="btn btn-primary-soft lift">
              {{ $service->d5 }}
            </a>
 -->
          <!-- </div> -->
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-12 col-md-10 col-lg-10">
            ...
            <h2>
              {{ $service->d13 }}<br>
              <span class="text-primary">{{ $service->d14 }}.</span>
            </h2>
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <span class="badge badge-pill badge-success-soft mb-3">
              <span class="h6 text-uppercase">{{ $service->d19 }}</span>
            </span>

            <!-- Heading -->
            <h2>
              {{ $service->d20 }} <br>
              <span class="text-success">{{ $service->d21 }}</span>.
            </h2>
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6 col-lg-5 order-md-2">
            ...
            <!-- <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase">{{ $service->d27 }}</span>
            </span> -->

            <!-- Heading -->
            <h2>
              {{ $service->d28 }} <br>
              <span class="text-primary">{{ $service->d29 }}</span>.
            </h2>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Heading -->
            <h2>
              {{ $service->d32 }} <span class="text-success">{{ $service->d33 }}</span>
            </h2>
          ...
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <div class="card card-border card-border-xl border-success shadow-light-lg mb-6 mb-md-0 lift lift-lg">
              <div class="card-body">
                ...
                <!-- Badge -->
                <h6 class="font-weight-bold text-uppercase text-center text-success mb-5">{{ $service->d37 }}</h6>

                <!-- Price -->
                <!-- <div class="d-flex justify-content-center">
                  <span class="h2 mb-0 mt-2">{{ $service->d38 }}</span>
                  <span class="price display-2 mb-0" data-annual="29" data-monthly="49">29</span>
                  <span class="h2 align-self-end mb-1">{{ $service->d39 }}</span>
                </div>
 -->
                <!-- Text -->
          ...
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <div class="card card-border card-border-xl border-dark shadow-light-lg lift lift-lg">
              <div class="card-body">
                ...
                <!-- Badge -->
                <h6 class="font-weight-bold text-uppercase text-center mb-5">{{ $service->d45 }}</h6>

                <!-- Price -->
               <!--  <div class="d-flex justify-content-center">
                  <span class="h2 mb-0 mt-2">{{ $service->d46 }}</span>
                  <span class="price display-2 mb-0" data-annual="49" data-monthly="69">49</span>
                  <span class="h2 align-self-end mb-1">{{ $service->d47 }}</span>
                </div> -->
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <span class="badge badge-pill badge-gray-700-soft mb-3">
              <span class="h6 text-uppercase">{{ $service->d55 }}</span>
            </span>
            ...
            <a href="#!" class="btn btn-primary-desat lift">
              {{ $service->d58 }} <i class="fe fe-arrow-right ml-2"></i>
            </a>
