...
@section('title', 'Invidual Combo | Digital In-Corporation')
@section('description', '')
@section('keywords', 'home | Invidual Combo')
...
@section('content')
  ...
  @forelse ($services as $service)
    <!-- WELCOME
    ================================================== -->
    <section class="pt-8 pb-11 pt-md-9 pb-md-12 py-lg-14 bg-light bg-between" s>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-7 text-center" data-aos="fade-up">
            ...
            <a href="#!" class="btn btn-primary mr-1 lift">
              {{ $service->d3 }} <i class="fe fe-arrow-right ml-3"></i>
            </a>
            ...
            <div class="card shadow-light-lg mb-6 mb-md-0 lift lift-lg">
              <div class="card-body">
                ...
                <a href="#!" class="font-size-sm font-weight-bold text-decoration-none">
                  {{ $service->d8 }} <i class="fe fe-arrow-right ml-3"></i>
                </a>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="card shadow-light-lg mb-6 mb-md-0 lift lift-lg">
              <div class="card-body">
                ...
                <!-- Link -->
                <a href="#!" class="font-size-sm font-weight-bold text-decoration-none">
                  {{ $service->d12 }} <i class="fe fe-arrow-right ml-3"></i>
                </a>
      ...
      <div class="container pb-6 pb-md-8 border-bottom">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-auto">
            ...
            <!-- Button -->
            <a href="{{ $service->d61 }}" class="btn btn-primary-soft mr-1 lift">
              {{ $service->d60 }}
            </a>
            
            <a href="{{ $service->d63 }}" class="btn btn-primary lift">
              {{ $service->d62 }}
            </a>
