                ...
                <div class="row no-gutters">
                  <div class="col-4">
                    ...
                    <div class="w-150 mt-9 p-1 bg-white shadow-lg" data-aos="fade-up" data-aos-delay="100">
                      <img src="{{asset ('assets/ui/img/photos/photo-13.jpg')}}" class="img-fluid" alt="...">
                    </div>
                  ...
                  <div class="col-4">
                    ...
                    <div class="w-150 p-1 bg-white shadow-lg" data-aos="fade-up">
                      <img src="{{asset ('assets/ui/img/photos/photo-14.jpg')}}" class="img-fluid" alt="...">
                    </div>
                  ...
                  <div class="col-4 position-relative">
                    ...
                    <div class="w-150 mt-11 float-right p-1 bg-white shadow-lg" data-aos="fade-up" data-aos-delay="150">
                      <img src="{{asset ('assets/ui/img/photos/photo-15.jpg')}}" class="img-fluid" alt="...">
                    </div>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <a class="card mb-6 mb-lg-0 shadow-light-lg" href="#!">
              ...
              <!-- Image -->
              <div class="card-zoom">
                <img class="card-img-top" src="{{asset ('assets/ui/img/portfolio/portfolio-1.jpg')}}" alt="...">
              </div>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <a class="card mb-6 mb-lg-0 shadow-light-lg" href="#!">
              ...
              <!-- Image -->
              <div class="card-zoom">
                <img class="card-img-top" src="{{asset ('assets/ui/img/portfolio/portfolio-2.jpg')}}" alt="...">
              </div>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <a class="card d-md-none d-lg-flex shadow-light-lg" href="#!">
              ...
              <!-- Image -->
              <div class="card-zoom">
                <img class="card-img-top" src="{{asset ('assets/ui/img/portfolio/portfolio-4.jpg')}}" alt="...">
              </div>
