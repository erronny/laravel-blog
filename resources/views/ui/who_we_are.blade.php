        ...
        <div class="row align-items-center">
          <div class="col-12 col-md">
            ...
            <a href="#!" class="font-weight-bold font-size-sm text-decoration-none mb-3">
              <i class="fe fe-arrow-left mr-3"></i> All listings
            </a>
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="form-group mb-5">
                        ...
                        <input type="text" class="form-control" id="applyEmail" placeholder="hello@domain.com">
                      </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="form-group mb-5">
                        ...
                        <textarea id="applyMessage" rows="5" class="form-control" placeholder="Let us know!"></textarea>
                      </div>
