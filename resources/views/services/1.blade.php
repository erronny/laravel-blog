...
<style>
    textarea {
                                        ...
                                        ?>
                                        @else
                                        {{ Form::open(array('url' => 'admin/service','enctype'=>'multipart/form-data','autocomplete'=>"off")) }}
      ...
      <div class="container">
        <div class="row align-items-center text-center text-md-left">
          <div class="col-12 col-md-6">
            ...
            <!-- Image -->
            <img src="{{asset ('assets/ui/img/illustrations/illustration-8.png')}}" alt="..." class="img-fluid mw-130 float-right mb-6 mb-md-0" data-aos="fade-right"><a class="dropdown-item" data-toggle="modal">
                      Change</a><input  id="image1" name="image1" type="file">

                    <div class="text text-danger" id="image1Erro"></div>
                    @if($errors->has('image1'))
                     <div class="text text-danger">{{ $errors->first('image1') }}</div>
                    @endif
          ...
          <div class="col-12 col-md-6">
            ...
            <h1 class="display-1 font-weight-bold">
              <div data-aos="fade-left"><input type="text" name="d" id="d" value="{{old('d')?old('d'):$d}}" /></div>
              <div data-aos="fade-left" data-aos-delay="100"><input type="text" name="d1" id="d1" value="{{old('d1')?old('d1'):$d1}}" /></div>
            </h1>

            <!-- Text -->
            <p class="font-size-lg text-muted mb-0" data-aos="fade-left" data-aos-delay="200"><textarea name="d2" style="width:500px;  height:150px; ">{{old('d2')?old('d2'):$d2}}</textarea></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-4 text-center" data-aos="fade-up">
            ...
            <!-- Text -->
            <p class="text-muted mb-6 mb-md-0"><textarea name="d4" style="width:300px;  height:150px; ">{{old('d4')?old('d4'):$d4}}</textarea></p>
          ...
          <div class="col-12 col-md-4 text-center" data-aos="fade-up" data-aos-delay="50">
            ...
            <!-- Text -->
            <p class="text-muted mb-6 mb-md-0"><textarea name="d6" style="width:300px;  height:150px; ">{{old('d6')?old('d6'):$d6}}</textarea></p>
          ...
          <div class="col-12 col-md-4 text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Text -->
            <p class="text-muted mb-0"><textarea name="d8" style="width:300px;  height:150px; ">{{old('d8')?old('d8'):$d8}}</textarea></p>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-7 text-center">
            ...
            <p class="font-size-lg text-muted mb-7 mb-md-9">
              <textarea name="d10" style="width:500px;  height:80px; ">{{old('d10')?old('d10'):$d10}}</textarea>
            </p>
            ...
            <div class="card shadow-light-lg overflow-hidden" data-aos="fade-up">
              <div class="row">
                <div class="col-md-4 position-relative">
                  ...
                  <!-- Image -->
                  <img src="{{asset ('assets/ui/img/illustrations/illustration-8.png')}}" class="h-75 position-absolute right-0 mt-7 mr-n4" alt="...">
                ...
                <div class="col-md-8">
                  ...
                  <div class="card-body py-7 py-md-9 text-center">
                    ...
                    <!-- Text -->
                    <p class="text-muted mb-0"><textarea name="d12" style="width:220px;  height:120px; ">{{old('d12')?old('d12'):$d12}}</textarea>
                    </p>
                ...
                <input  id="image2" name="image2" type="file">
                    ...
                    @if($errors->has('image2'))
                     <div class="text text-danger">{{ $errors->first('image2') }}</div>
                    @endif
              </div> <!-- / .row -->
            </div>
            ...
            <div class="card shadow-light-lg overflow-hidden text-center" data-aos="fade-up">
              <div class="row">
                <div class="col-md-8">
                  ...
                  <div class="card-body py-7 py-md-9">
                    ...
                    <p class="text-muted mb-0">
                      <textarea name="d14" style="width:230px;  height:140px; ">{{old('d14')?old('d14'):$d14}}</textarea>
                    </p>
                  ...
                  <input  id="image3" name="image3" type="file">
                    ...
                    @if($errors->has('image3'))
                     <div class="text text-danger">{{ $errors->first('image3') }}</div>
                    @endif
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <!-- Image -->
                  <img src="{{asset ('assets/ui/img/illustrations/illustration-6.png')}}" class="h-75 position-absolute left-0 mt-7" alt="...">
            ...
            <div class="card shadow-light-lg overflow-hidden text-center text-lg-left" data-aos="fade-up">
              <div class="row">
                <div class="col-md-4 position-relative">
                  ...
                  <!-- Image -->
                  <img src="{{asset ('assets/ui/img/illustrations/illustration-2.png')}}" class="h-75 position-absolute right-0 mt-6" alt="...">
                ...
                <input  id="image4" name="image4" type="file">
                    ...
                    @if($errors->has('image4'))
                     <div class="text text-danger">{{ $errors->first('image4') }}</div>
                    @endif
              </div> <!-- / .row -->
            </div>
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #FF5A5F;">
                  <div class="card-body text-center">
                    ...
                    @if($errors->has('image5'))
                     <div class="text text-danger">{{ $errors->first('image5') }}</div>
                    @endif
                    </div>

                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d19" style="width:200px;  height:200px; ">{{old('d19')?old('d19'):$d19}}</textarea>
                    </p>

                    <!-- Link -->
                    <input type="text" id="d20" name="d20" value="{{old('d20')?old('d20'):$d20}}" /></br>
                    <input type="text" id="d21" name="d21" value="{{old('d21')?old('d21'):$d21}}" />
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #B81D24;">
                  <div class="card-body text-center">
                    ...
                    @if($errors->has('image6'))
                     <div class="text text-danger">{{ $errors->first('image6') }}</div>
                    @endif
                    </div>

                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d22" style="width:200px;  height:200px; ">{{old('d22')?old('d22'):$d22}}</textarea>
                    </p>

                    <!-- Link -->
                    <input type="text" id="d23" name="d23" value="{{old('d23')?old('d23'):$d23}}" /></br>
                    <input type="text" id="d24" name="d24" value="{{old('d24')?old('d24'):$d24}}" />
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #0081C9;">
                  <div class="card-body text-center">
                    ...
                    @if($errors->has('image7'))
                     <div class="text text-danger">{{ $errors->first('image7') }}</div>
                    @endif
                    </div>
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d25" style="width:200px;  height:200px; ">{{old('d25')?old('d25'):$d25}}</textarea>
                    </p>

                    <!-- Link -->
                    <input type="text" id="d26" name="d26" value="{{old('d26')?old('d26'):$d26}}" /></br>
                    <input type="text" id="d27" name="d27" value="{{old('d27')?old('d27'):$d27}}" />
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #6772E5;">
                  <div class="card-body text-center">
                    ...
                    @if($errors->has('image8'))
                     <div class="text text-danger">{{ $errors->first('image8') }}</div>
                    @endif
                    </div>
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d28" style="width:200px;  height:200px; ">{{old('d28')?old('d28'):$d28}}</textarea>
                    </p>

                    <input type="text" id="d29" name="d29" value="{{old('d29')?old('d29'):$d29}}" /></br>
                    <input type="text" name="d30" id="d30" value="{{old('d33')?old('d30'):$d30}}" />
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #CB2027;">
                  <div class="card-body text-center">
                    ...
                    @if($errors->has('image9'))
                     <div class="text text-danger">{{ $errors->first('image9') }}</div>
                    @endif
                    </div>
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d31" style="width:200px;  height:200px; ">{{old('d31')?old('d31'):$d31}}</textarea>
                    </p>

                    <input type="text" id="d32" name="d32" value="{{old('d32')?old('d32'):$d32}}" /></br>
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #DA5988;">
                  <div class="card-body text-center">
                    ...
                    @if($errors->has('image10'))
                     <div class="text text-danger">{{ $errors->first('image10') }}</div>
                    @endif
                    </div>

                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d34" style="width:200px;  height:200px; ">{{old('d34')?old('d34'):$d34}}</textarea>
                    </p>

                    <input type="text" id="d35" name="d35" value="{{old('d35')?old('d35'):$d35}}" /></br>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-6">
            ...
            <!-- Heading -->
            <h2 class="font-weight-bold">
              <input type="text" name="d37"  value="{{old('d37')?old('d37'):$d37}}" />
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-muted mb-5"><textarea name="d38" style="width:500px;  height:200px; ">
              {{old('d38')?old('d38'):$d38}}</textarea>
            </p>

            <!-- Button -->
            <a href="#!" class="btn btn-primary-desat mb-6 mb-md-0 lift">
              <input type="text" name="d39" id="d39" value="{{old('d39')?old('d39'):$d39}}" /> <i class="fe fe-arrow-right ml-3"></i>
            </a>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="w-md-130">
              ...
              <input  id="image11" name="image11" type="file">
                    ...
                    @if($errors->has('image11'))
                     <div class="text text-danger">{{ $errors->first('image11') }}</div>
                    @endif
            </div>
        ...
        <div class="row">
          <div class="col-12 col-md-4 text-center">
            ...
            <p class="text-muted mb-6 mb-md-0">
             <textarea name="d41" style="width:300px;  height:150px;" >{{old('d41')?old('d41'):$d41}}</textarea>
            </p>
          ...
          <div class="col-12 col-md-4 text-center">
            ...
            <!-- Text -->
            <p class="text-muted mb-6 mb-md-0">
              <textarea name="d43" style="width:300px;  height:150px;" >{{old('d43')?old('d43'):$d43}}</textarea>
            </p>
          ...
          <div class="col-12 col-md-4 text-center">
            ...
            <!-- Text -->
            <p class="text-muted mb-0">
              <textarea name="d45" style="width:300px;  height:150px;" >{{old('d45')?old('d45'):$d45}} </textarea>
            </p>
