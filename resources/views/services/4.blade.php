...
<style>
    textarea {
                                        ...
                                        {{ Form::model($service, array('route' => array('service4.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                        <?php  
                                          $id           = $service->id;
                                          $d           = $service->d;
                                          $d1           = $service->d1;
      ...
      <div class="container">
        <div class="row justify-content-between align-items-stretch">
          ...
          <div class="col-12 col-md-5">
            ...
            <!-- Image -->
            <div class="position-relative h-100 vw-50 bg-cover" style="background-image: url(assets/ui/img/covers/);">
