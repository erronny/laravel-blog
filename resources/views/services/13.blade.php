...
<style>
    textarea {
                                        ...
                                        {{ Form::model($service, array('route' => array('service13.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                        <?php  
                                          $id           = $service->id;
                                          $d           = $service->d;
                                          $d1           = $service->d1;
                                        ...
                                        ?>
                                        @else
                                        {{ Form::open(array('url' => 'admin/service6','enctype'=>'multipart/form-data','autocomplete'=>"off")) }}
      ...
      <div class="container">
        <div class="row align-items-stretch">
          ...
          <div class="col-12 col-md-5 py-8 py-md-14 order-md-1" data-aos="fade-right">
            ...
            <!-- Heading -->
            <h1 class="display-3">
              <input type="text" name="d" id="d" value="{{old('d')?old('d'):$d}}" /> <span class="text-success"><input type="text" name="d1" id="d1" value="{{old('d1')?old('d1'):$d1}}" /></span>
            </h1>

            <!-- Text -->
            <p class="lead text-muted mb-6 mb-md-8">
              <textarea name="d2" style="height:150px; width:200px" >{{old('d2')?old('d2'):$d2}}</textarea>
            </p>
            ...
            <!-- Form -->
              ...
              <div class="form-row">
                ...
                <div class="col-12 col-lg-auto">
                  ...
                  <p>URL<input type="text" name="d61" id="d61" value="{{old('d61')?old('d61'):$d61}}" /> </p>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <span class="badge badge-pill badge-success-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d5" id="d5" value="{{old('d5')?old('d5'):$d5}}" /></span>
            </span>
            ...
            <p class="font-size-lg text-gray-700 mb-7 mb-md-9">
              <textarea name="d7" style="height:150px; width:200px" >{{old('d7')?old('d7'):$d7}}</textarea>
            </p>
              ...
              <div class="card-body position-relative">
                ...
                <div class="position-relative text-right mt-n8 mr-n4 mb-3">
                  <span class="badge badge-pill badge-success">
                    <span class="h6 text-uppercase"><input type="text" name="d8" id="d8" value="{{old('d8')?old('d8'):$d8}}" /></span>
                  </span>
                </div>
                ...
                <a  class="font-weight-bold text-decoration-none">
                  <input type="text" name="d11" id="d11" value="{{old('d11')?old('d11'):$d11}}" /> <i class="fe fe-arrow-right ml-3"></i>
                </a></br>
                <p>URL<input type="text" name="d12" id="d12" value="{{old('d12')?old('d12'):$d12}}" /></p>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="card shadow-light-lg mb-6 mb-md-0 lift lift-lg">
              ...
              <div class="card-body position-relative">
                ...
                <!-- Text -->
                <p class="text-muted">
                  <textarea name="d15" style="height:150px; width:200px" >{{old('d15')?old('d15'):$d15}}</textarea>
                </p>

                <!-- Link -->
                <a  class="font-weight-bold text-decoration-none">
                  <input type="text" name="d16" id="d16" value="{{old('d16')?old('d16'):$d16}}" /> <i class="fe fe-arrow-right ml-3"></i>
                </a>
                <p>URL<input type="text" name="d17" id="d17" value="{{old('d17')?old('d17'):$d17}}" /></p>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <div class="card-body position-relative">
                ...
                <div class="position-relative text-right mt-n8 mr-n4 mb-3">
                  <span class="badge badge-pill badge-success">
                    <span class="h6 text-uppercase"><input type="text" name="d18" id="d18" value="{{old('d18')?old('d18'):$d18}}" /></span>
                  </span>
                </div>
                ...
                <!-- Text -->
                <p class="text-muted">
                  <textarea name="d20" style="height:150px; width:200px" >{{old('d20')?old('d20'):$d20}}</textarea>
                </p>

                <!-- Link -->
                <a  class="font-weight-bold text-decoration-none">
                  <input type="text" name="d21" id="d21" value="{{old('d21')?old('d21'):$d21}}" /> <i class="fe fe-arrow-right ml-3"></i>
                </a>
                <p>URL<input type="text" name="d22" id="d22" value="{{old('d22')?old('d22'):$d22}}" /></p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-6 order-md-1">
            ...
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d23" id="d23" value="{{old('d23')?old('d23'):$d23}}" /></span>
            </span>

            <!-- Heading -->
            <h2>
              <input type="text" name="d24" id="d24" value="{{old('d24')?old('d24'):$d24}}" /> <br>
              <span class="text-primary"><input type="text" name="d25" id="d25" value="{{old('d25')?old('d25'):$d25}}" /></span>.
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-gray-700 mb-6 mb-md-6">
              <textarea name="d26" style="height:150px; width:200px" >{{old('d26')?old('d26'):$d26}}</textarea>
            </p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-6 col-lg-5 offset-lg-1 py-8 py-md-11 py-lg-12">
            ...
            <!-- Heading -->
            <h2>
              <input type="text" name="d31" id="d31" value="{{old('d31')?old('d31'):$d31}}" /> <span data-toggle="countup" data-from="100" data-to="400" data-aos data-aos-id="countup:in"></span><br>From<input type="text" name="d32" id="d32" value="{{old('d32')?old('d32'):$d32}}" />TO<input type="text" name="d33" id="d33" value="{{old('d33')?old('d33'):$d33}}" /> <input type="text" name="d34" id="d34" value="{{old('d34')?old('d34'):$d34}}" /> <br>
              <span class="text-success"><input type="text" name="d35" id="d35" value="{{old('d35')?old('d35'):$d35}}" /></span>.
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-gray-700 mb-6 mb-md-6">
              <textarea name="d36" style="height:150px; width:200px" >{{old('d36')?old('d36'):$d36}}</textarea>
            </p>
            ...
            <div class="d-flex">
              <div class="pr-5">
                <h3 class="text-success mb-0">
                  <input type="text" name="d37" id="d37" value="{{old('d37')?old('d37'):$d37}}" />
                </h3>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Heading -->
            <h2>
              <span class="text-primary"><input type="text" name="d43" id="d43" value="{{old('d43')?old('d43'):$d43}}" /></span> <input type="text" name="d44" id="d44" value="{{old('d44')?old('d44'):$d44}}" />
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-muted mb-7 mb-md-9 px-md-9">
              <textarea name="d45" style="height:150px; width:200px" >{{old('d45')?old('d45'):$d45}}</textarea>
            </p>
                ...
                <div class="list-group list-group-flush">
                  <div class="list-group-item">
                    ...
                    <a class="d-flex align-items-center text-reset text-decoration-none" data-toggle="collapse" href="#featuresOne" role="button" aria-expanded="true" aria-controls="featuresOne">
                      ...
                      <span class="badge badge-pill badge-success-soft ml-4">
                        <span class="h6 text-uppercase"><input type="text" name="d48" id="d48" value="{{old('d48')?old('d48'):$d48}}" /></span>
                      </span>
                    ...
                    <div class="collapse show" id="featuresOne" data-parent="#featuresAccordion">
                      <div class="py-5 py-mb-6">
                        <p>
                          <textarea name="d49" style="height:150px; width:500px" >{{old('d49')?old('d49'):$d49}}</textarea>
                        </p>
                        <a  class="font-weight-bold text-decoration-none">
                          <input type="text" name="d50" id="d50" value="{{old('d50')?old('d50'):$d50}}" /> <i class="fe fe-arrow-right ml-3"></i>
                        </a><br>
                        <p>URL<input type="text" name="d51" id="d51" value="{{old('d51')?old('d51'):$d51}}" /></p>
                      </div>
                    </div>
                  ...
                  <div class="list-group-item">
                    ...
                    <div class="collapse" id="featuresTwo" data-parent="#featuresAccordion">
                      <div class="py-5 py-md-6">
                        <p>
                          <textarea name="d54" style="height:150px; width:500px" >{{old('d54')?old('d54'):$d54}}</textarea>
                        </p>
                        <a  class="font-weight-bold text-decoration-none">
                          <input type="text" name="d55" id="d55" value="{{old('d55')?old('d55'):$d55}}" /> <i class="fe fe-arrow-right ml-3"></i>
                        </a><br>
                        <p>URL<input type="text" name="d62" id="d62" value="{{old('d62')?old('d62'):$d62}}" /> </p>
                      </div>
                    </div>
                  ...
                  <div class="list-group-item">
                    ...
                    <div class="collapse" id="featuresThree" data-parent="#featuresAccordion">
                      <div class="py-5 py-md-6">
                        <p>
                          <textarea name="d58" style="height:150px; width:500px" >{{old('d58')?old('d58'):$d58}}</textarea>
                        </p>
                        <a  class="font-weight-bold text-decoration-none">
                          <input type="text" name="d59" id="d59" value="{{old('d59')?old('d59'):$d59}}" /> <i class="fe fe-arrow-right ml-3"></i>
                        </a>
                        <p>URL<input type="text" name="d60" id="d60" value="{{old('d60')?old('d60'):$d60}}" /></p>
                      </div>
                    </div>
