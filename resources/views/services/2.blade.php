...
<style>
    textarea {
                                        ...
                                        {{ Form::model($service, array('route' => array('service2.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                        <?php  
                                          $id           = $service->id;
                                          $d           = $service->d;
                                          $d1           = $service->d1;
          ...
          <div class="col-12 order-md-2">
           ...
           <!--  <div class="device-combo device-combo-macbook-iphonex mb-6 mb-md-0" -->>
              ...
              <!-- <div class="device device-macbook">
                ...
                <img src="{{asset ('assets/ui/img/devices/mackbook.jpg')}}" class="img-fluid" alt="...">
              </div> -->
