...
<style>
    textarea {
                                        ...
                                        {{ Form::model($service, array('route' => array('service10.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                        <?php  
                                          $id           = $service->id;
                                          $d           = $service->d;
                                          $d1           = $service->d1;
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #FF5A5F;">
                  <div class="card-body text-center">
                    ...
                    <p class="text-gray-700 mb-5">
                     <textarea name="d33" style="width:200px;  height:150px;">{{old('d33')?old('d33'):$d33}}</textarea> 
                    </p>

                    <!-- Link -->
                    <a  style="color: #FF5A5F;"><input type="text" name="d34" id="d34" value="{{old('d34')?old('d34'):$d34}}" /></a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #B81D24;">
                  <div class="card-body text-center">
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d35" style="width:200px;  height:150px;">{{old('d35')?old('d35'):$d35}}</textarea>
                    </p>

                    <!-- Link -->
                    <a  style="color: #B81D24;"><input type="text" name="d36" id="d36" value="{{old('d36')?old('d36'):$d36}}" /></a>
                    <input type="text" name="d67" id="d67" value="{{old('d67')?old('d67'):$d67}}" />
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #0081C9;">
                  <div class="card-body text-center">
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d37" style="width:200px;  height:150px;">{{old('d37')?old('d37'):$d37}}</textarea>
                    </p>

                    <!-- Link -->
                    <a  style="color: #0081C9;"><input type="text" name="d38" id="d38" value="{{old('d38')?old('d38'):$d38}}" /></a>
                    <input type="text" name="d68" id="d68" value="{{old('d68')?old('d68'):$d68}}" />
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #6772E5;">
                  <div class="card-body text-center">
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d39" style="width:200px;  height:150px;">{{old('d39')?old('d39'):$d39}}</textarea>
                    </p>

                    <!-- Link -->
                    <a  style="color: #6772E5;"><input type="text" name="d40" id="d40" value="{{old('d40')?old('d40'):$d40}}" /></a>
                    <input type="text" name="d69" id="d69" value="{{old('d69')?old('d69'):$d69}}" />
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #CB2027;">
                  <div class="card-body text-center">
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d41" style="width:200px;  height:150px;">{{old('d41')?old('d41'):$d41}}</textarea>
                    </p>

                    <!-- Link -->
                    <a  style="color: #CB2027;"><input type="text" name="d42" id="d42" value="{{old('d42')?old('d42'):$d42}}" /></a>
                    <input type="text" name="d70" id="d70" value="{{old('d70')?old('d70'):$d70}}" />
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #DA5988;">
                  <div class="card-body text-center">
                    ...
                    <!-- Text -->
                    <p class="text-gray-700 mb-5">
                      <textarea name="d43" style="width:200px;  height:150px;">{{old('d43')?old('d43'):$d43}}</textarea>
                    </p>

                    <!-- Link -->
                    <a  style="color: #DA5988;"><input type="text" name="d44" id="d44" value="{{old('d44')?old('d44'):$d44}}" /></a>
                    <input type="text" name="d71" id="d71" value="{{old('d71')?old('d71'):$d71}}" />
