...
<style>
    textarea {
                                        ...
                                        {{ Form::model($service, array('route' => array('service11.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                        <?php  
                                          $id           = $service->id;
                                          $d           = $service->d;
                                          $d1           = $service->d1;
                                        ...
                                        ?>
                                        @else
                                        {{ Form::open(array('url' => 'admin/service4','enctype'=>'multipart/form-data','autocomplete'=>"off")) }}
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <p class="lead text-muted mb-6" data-aos="fade-up" data-aos-delay="100">
              <textarea name="d2" id="d2" style="width: 300px; height: 150px">{{old('d2')?old('d2'):$d2}}</textarea>
            </p>
        ...
        <div class="row">
          <div class="col-12" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="embed-responsive embed-responsive-16by9">
              <video class="embed-responsive-item rounded-lg bg-light shadow-lg" src="{{asset ('assets/ui/video/video-1.mp4')}}" autoplay loop muted>
                Sorry, your browser doesn't support embedded videos,
                but don't worry, you can <a href="{{asset ('assets/ui/video/video-1.mp4')}}">download it</a>
      ...
      <div class="container">
        <div class="row justify-content-between align-items-center mb-5">
          <div class="col-12 col-md-4 order-md-2 text-center">
            ...
            <!-- Image -->
            <img class="img-fluid w-75 w-md-100 mb-6 mb-md-0" src="{{asset ('assets/ui/img/illustrations/illustration-1-dark.png')}}" alt="...">
          ...
          <div class="col-12 col-md-7 order-md-1">
            ...
            <div class="lead text-muted-80 mb-0">
              <textarea name="d6" style="height:150px; width:300px" >{{old('d6')?old('d6'):$d6}}</textarea>
            </div>
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-12 col-md-6 col-lg-5 order-md-2">
            ...
            <div class="d-flex flex-column w-md-130 mb-6 mb-md-0">
              ...
              <!-- Image -->
              <img class="img-fluid rounded shadow align-self-start" data-jarallax-element="-20" src="{{asset ('assets/ui/img/screenshots/ui/analytics-2.png')}}" alt="..." style="min-height: 1px; max-width: 50%; margin-left: 40%;">

              <!-- Image -->
              <img class="img-fluid rounded shadow align-self-start" data-jarallax-element="-50" src="{{asset ('assets/ui/img/screenshots/ui/analytics-1.png')}}" alt="..." style="min-height: 1px; max-width: 50%; margin-top: -35%;">

              <!-- Image -->
              <img class=" img-fluid rounded shadow align-self-center" data-jarallax-element="-80" src="{{asset ('assets/ui/img/screenshots/ui/analytics-3.png')}}" alt="..." style="min-height: 1px; max-width: 50%; margin-top: -20%;">
          ...
          <div class="col-12 col-md-6 order-md-1 pt-md-12">
            ...
            <p class="font-size-lg text-gray-700 mb-6">
              <textarea name="d14" style="height:150px; width:200px" >{{old('d14')?old('d14'):$d14}}</textarea>
            </p>
              ...
              <div class="col-12 col-lg-6">
                ...
                <div class="d-flex">
                  ...
                  <p class="text-success">
                    <input type="text" name="d15" id="d15" value="{{old('d15')?old('d15'):$d15}}" />
                  </p>
                ...
                <div class="d-flex">
                  ...
                  <p class="text-success mb-lg-0">
                    <input type="text" name="d16" id="d16" value="{{old('d16')?old('d16'):$d16}}" />
                  </p>
        ...
        <div class="row justify-content-between align-items-stretch">
          <div class="col-12 col-md-6 py-8 py-md-13">
            ...
            <p class="font-size-lg text-gray-700 mb-7">
              <textarea name="d24" style="height:150px; width:200px" >{{old('d24')?old('d24'):$d24}}</textarea>
            </p>

            <!-- Button -->
            <a class="text-reset d-inline-block mr-1" href="#!">
              <img src="{{asset ('assets/ui/img/buttons/button-app.png')}}" class="img-fluid" alt="..." style="max-width: 155px;">
            </a>

            <!-- Button -->
            <a class="text-reset d-inline-block" href="#!">
              <img src="{{asset ('assets/ui/img/buttons/button-play.png')}}" class="img-fluid" alt="..." style="max-width: 155px;">
            </a>
          ...
          <div class="col-12 col-md-5">
            ...
            <!-- Image -->
            <div class="position-relative h-100 vw-50 bg-cover" style="background-image: url(assets/ui/img/covers/cover-18.jpg);">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Preheading -->
            <h6 class="text-uppercase text-warning"><input type="text" name="d25" id="d25" value="{{old('d25')?old('d25'):$d25}}" /></h6>
            ...
            <p class="font-size-lg text-muted mb-9">
              <textarea name="d27" style="height:150px; width:200px" >{{old('d27')?old('d27'):$d27}}</textarea>
            </p>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-4 text-center">
            ...
            <p class="text-muted mb-8">
              <textarea name="d29" style="height:150px; width:200px" >{{old('d29')?old('d29'):$d29}}</textarea>
            </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 text-center">
            ...
            <p class="text-muted mb-8 mb-lg-0">
              <textarea name="d31" style="height:150px; width:200px" >{{old('d31')?old('d31'):$d31}}</textarea>
            </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 text-center">
            ...
            <p class="text-muted mb-8 mb-md-0">
              <textarea name="d33" style="height:150px; width:200px" >{{old('d33')?old('d33'):$d33}}</textarea>
            </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 text-center">
            ...
            <!-- Heading -->
            <h3 class="font-weight-bold text-white">
              <input type="text" name="d34" id="d34" value="{{old('d34')?old('d34'):$d34}}" />
            </h3>

            <!-- Text -->
            <p class="text-muted mb-8 mb-lg-0">
              <textarea name="d35" style="height:150px; width:200px" >{{old('d35')?old('d35'):$d35}}</textarea>
            </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 text-center">
            ...
            <!-- Text -->
            <p class="text-muted mb-8 mb-md-0">
              <textarea name="d37" style="height:150px; width:200px" >{{old('d37')?old('d37'):$d37}}</textarea>
            </p>
      ...
      <div class="container py-6 py-md-8 border-top border-bottom border-gray-900-50">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-auto">
            ...
            <p>URL<input type="text" name="d43" id="d43" value="{{old('d43')?old('d43'):$d43}}" /></p>
