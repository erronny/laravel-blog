...
<style>
    textarea {
                                        ...
                                        {{ Form::model($service, array('route' => array('service7.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                        <?php  
                                          $id           = $service->id;
                                          $d           = $service->d;
                                          $d1           = $service->d1;
...
<!-- NAVBAR
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 text-center">
            ...
            <p>Link<input type="text" name="d2" id="d2" value="{{old('d2')?old('d2'):$d2}}" /></p>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d3" id="d3" value="{{old('d3')?old('d3'):$d3}}" /></span>
            </span>

            <!-- Heading -->
            <h1>
              <input type="text" name="d4" id="d4" value="{{old('d4')?old('d4'):$d4}}" /> <span class="text-primary"><input type="text" name="d5" id="d5" value="{{old('d5')?old('d5'):$d5}}" /></span>
            </h1>

            <!-- Text -->
            <p class="lead text-gray-700 mb-7 mb-md-9">
              <textarea name="d6" style="height:150px; width:200px" >{{old('d6')?old('d6'):$d6}}</textarea>
            </p>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6 col-lg-7">
            ...
            <div class="mb-8 mb-md-0">
              ...
              <!-- Image -->
              <img src="{{asset ('assets/ui/img/screenshots/desktop/rental.jpg')}}" alt="..." class="screenshot img-fluid mw-md-110 float-right mr-md-6 mb-6 mb-md-0">
          ...
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <div class="d-flex">
              ...
              <div class="ml-5">
                ...
                <!-- Heading -->
                <h3>
                  <input type="text" name="d7" id="d7" value="{{old('d7')?old('d7'):$d7}}" /> 
                </h3>

                <!-- Text -->
                <p class="text-gray-700 mb-6">
                  <textarea name="d8" style="height:150px; width:200px" >{{old('d8')?old('d8'):$d8}}</textarea>
                </p>
            ...
            <div class="d-flex">
              ...
              <div class="ml-5">
                ...
                <!-- Text -->
                <p class="text-gray-700 mb-6">
                 <textarea name="d10" style="height:150px; width:200px" >{{old('d10')?old('d10'):$d10}}</textarea>
                </p>
            ...
            <div class="d-flex">
              ...
              <div class="ml-5">
                ...
                <!-- Heading -->
                <h3>
                  <input type="text" name="d11" id="d11" value="{{old('d11')?old('d11'):$d11}}" />
                </h3>

                <!-- Text -->
                <p class="text-gray-700 mb-0">
                  <textarea name="d12" style="height:150px; width:200px" >{{old('d12')?old('d12'):$d12}}</textarea>
                </p>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-6">
            ...
            <!-- Badge -->
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d13" id="d13" value="{{old('d13')?old('d13'):$d13}}" /></span>
            </span>

            <!-- Heading -->
            <h2>
              <input type="text" name="d14" id="d14" value="{{old('d14')?old('d14'):$d14}}" /> <br>
              <span class="text-primary"><input type="text" name="d15" id="d15" value="{{old('d15')?old('d15'):$d15}}" /></span>.
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-gray-700 mb-6">
              <textarea name="d16" style="height:150px; width:400px" >{{old('d16')?old('d16'):$d16}}</textarea>
            </p>
          ...
          <div class="col-12 col-md-6">
            ...
            <!-- Image -->
            <img src="{{ asset ('assets/ui/img/illustrations/illustration-3.png')}}" alt="..." class="img-fluid mw-md-130">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Badge -->
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d21" id="d21" value="{{old('d21')?old('d21'):$d21}}" /></span>
            </span>
            ...
            <p class="font-size-lg text-muted mb-7 mb-md-9">
              <textarea name="d23" style="height:150px; width:200px" >{{old('d23')?old('d23'):$d23}}</textarea>
            </p>
            ...
            <div class="card mb-6 mb-lg-0 pt-14 overlay overlay-black overlay-30 bg-cover shadow-light-lg lift lift-lg" style="background-image: url(assets/ui/img/photos/photo-8.jpg);">
              ...
              <a class="card-body mt-auto" href="#!">
                ...
                <p class="mb-0 text-white">
                  <textarea name="d25" style="height:200px; width:200px" >{{old('d25')?old('d25'):$d25}}</textarea>
                </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                <img src="{{asset ('assets/ui/img/photos/photo-7.jpg')}}" alt="..." class="img-fluid">
              </a>
              ...
              <a class="card-body">
                ...
                <!-- Heading -->
                <h3>
                  <input type="text" name="d28" id="d28" value="{{old('d28')?old('d28'):$d28}}" />
                </h3>

                <!-- Text -->
                <p class="mb-0 text-muted">
                  <textarea name="d29" style="height:200px; width:200px" >{{old('d29')?old('d29'):$d29}}</textarea>
              ...
              <a class="card-meta" >
                ...
                <h6 class="text-uppercase text-muted mr-2 mb-0">
                  <input type="text" name="d30" id="d30" value="{{old('d30')?old('d30'):$d30}}" />
                </h6>
                
                <!-- Date -->
                <p class="h6 text-uppercase text-muted mb-0 ml-auto">
                  <time datetime="2019-05-02"><input type="text" name="d31" id="d31" value="{{old('d31')?old('d31'):$d31}}" /></time>
                </p>

              </a><p>LINK
              <input type="text" name="d32" id="d32" value="{{old('d32')?old('d32'):$d32}}" /></p>
          ...
          <div class="col-12 col-lg-4 d-flex">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <a class="card-body my-auto" href="#!">
                ...
                <!-- Heading -->
                <h3 class="mt-auto">
                  <input type="text" name="d33" id="d33" value="{{old('d33')?old('d33'):$d33}}" />
                </h3>

                <!-- Text -->
                <p class="mb-0 text-muted">
                  <textarea name="d34" style="height:200px; width:200px" >{{old('d34')?old('d34'):$d34}}</textarea>
                </p>
              ...
              <a class="card-meta" >
                ...
                <!-- Author -->
                <h6 class="text-uppercase text-muted mr-2 mb-0">
                  <input type="text" name="d36" id="d36" value="{{old('d36')?old('d36'):$d36}}" />
                </h6>
                
                <!-- Date -->
                <p class="h6 text-uppercase text-muted mb-0 ml-auto">
                  <time datetime="2019-05-02"><input type="text" name="d37" id="d37" value="{{old('d37')?old('d37'):$d37}}" /></time>
                </p>

              </a><p>LINK
              <input type="text" name="d38" id="d38" value="{{old('d38')?old('d38'):$d38}}" /></p>
        ...
        <div class="row align-items-stretch">
          <div class="col-12 col-md-5">
            ...
            <blockquote class="blockquote text-center">
              ...
              <p class="mb-5 mb-md-7">
                <textarea name="d39" style="height:150px; width:200px" >{{old('d39')?old('d39'):$d39}}</textarea>
              </p>

              <!-- Footer -->
              <footer class="blockquote-footer mb-8 mb-md-0">
                <div class="avatar mr-3">
                  <img src="{{asset ('assets/ui/img/avatars/avatar-2.jpg')}}" class="avatar-img rounded-circle" alt="...">
                </div> <span class="h6 text-uppercase"><input type="text" name="d40" id="d40" value="{{old('d40')?old('d40'):$d40}}" /></span>
              </footer>
          ...
          <div class="col-12 col-md-5 offset-md-1">
            ...
            <blockquote class="blockquote text-center">
              ...
              <!-- Text -->
              <p class="mb-5 mb-md-7">
                <textarea name="d41" style="height:150px; width:200px" >{{old('d41')?old('d41'):$d41}}</textarea>
              </p>

              <!-- Footer -->
              <footer class="blockquote-footer mb-0">
                <div class="avatar mr-3">
                  <img src="{{asset ('assets/ui/img/avatars/avatar-1.jpg')}}" class="avatar-img rounded-circle" alt="...">
                </div> <span class="h6 text-uppercase"><input type="text" name="d42" id="d42" value="{{old('d42')?old('d42'):$d42}}" /></span>
              </footer>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-1- col-lg-8 text-center">
            ...
            <p class="font-size-lg text-white-80 mb-6 mb-md-8">
              <textarea name="d44" style="height:150px; width:200px" >{{old('d44')?old('d44'):$d44}}</textarea>
            </p>
 ...
 <i class="fe fe-arrow-right ml-2"></i>
            ...
            <p>URL<input type="text" name="d46" id="d46" value="{{old('d46')?old('d46'):$d46}}" />
</p>
