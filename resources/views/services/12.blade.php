...
<style>
    textarea {
                                        ...
                                        {{ Form::model($service, array('route' => array('service12.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                        <?php  
                                          $id           = $service->id;
                                          $d           = $service->d;
                                          $d1           = $service->d1;
        ...
        <div class="row justify-content-between">
          <div class="col-12 col-md">
            ...
            <blockquote class="blockquote mb-8 mb-md-0">
              ...
              <p class="lead text-gray-700 mb-5 mb-md-7">
                <textarea name="d7" style="height:150px; width:300px" >{{old('d7')?old('d7'):$d7}}</textarea>
              </p>
          ...
          <div class="col-12 col-md">
            ...
            <blockquote class="blockquote mb-0">
              ...
              <!-- Text -->
              <p class="lead text-gray-700 mb-5 mb-md-7">
                <textarea name="d10" style="height:150px; width:300px" >{{old('d10')?old('d10'):$d10}}</textarea> 
              </p>
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6">
            ...
            <div class="img-skewed img-skewed-right mb-10 mb-md-0">
              <img src="{{asset ('assets/ui/img/screenshots/ui/dashkit-layered.png')}}" alt="..." class="img-fluid" data-aos="img-skewed-item-right">
            </div>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              <div class="col-6 mt-8 mr-n5" data-aos="fade-up">
                ...
                <img src="{{asset ('assets/ui/img/photos/photo-10.jpg')}}" alt="..." class="img-fluid mb-4 rounded">

                <img src="{{asset ('assets/ui/img/photos/photo-12.jpg')}}" alt="..." class="img-fluid rounded">

              </div>
              <div class="col-6" data-aos="fade-up" data-aos-delay="100">
                
                <img src="{{asset ('assets/ui/img/photos/photo-9.jpg')}}" alt="..." class="img-fluid mb-4 rounded">

                <img src="{{asset ('assets/ui/img/photos/photo-11.jpg')}}" alt="..." class="img-fluid rounded">
          ...
          <div class="col-12 col-md-6 order-md-1" data-aos="fade-up">
            ...
            <div class="w-100 w-md-130 float-right mb-6 mb-md-0">
              ...
              <div class="device device-macbook">
                <img src="{{asset ('assets/ui/img/screenshots/desktop/dashkit-alt-dark.jpg')}}" class="device-screen" alt="...">
