              ...
              <div class="card-header">
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    ...
                    <!-- Link -->
                    <a class="small text-gray-700" href="{{ count($devices) > 1 ? '/logout/all' : '#' }}" class="btn btn-danger {{ count($devices) == 1 ? 'disabled' : '' }}">
                      Log out all
                    </a>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col ml-n5">
                        ...
                        <small class="text-gray-700">
                          IP {{ $device->ip_address }} · at 

                           {{ date('d-m-Y', ($device->last_activity)) }} 
                      ...
                      @if ($current_session_id == $device->id)
                        ...
                        <a class="btn btn-danger" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Log Out</a>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                                            {{ csrf_field() }}
                                                          </form>
                      @else
                      <a href="/logout/{{$device->id}}" class="btn btn-danger">Log Out</a>
                      @endif
