...
<!--Page Title Section Satrt-->
  ...
  <section id="service_page">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(asset('pan')); ?>"><img src="images/service/pan.png" class="img-circle htw" alt="pan card" style="color:white"/></a>
          <h4><a href="<?php echo e(asset('pan')); ?>">Pan Card</a></h4>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img active"> <a href="<?php echo e(asset('pwd')); ?>"><img src="images/service/PWD.png" class="img-circle htw" alt="pwd" /></a>
          <h4><a href="<?php echo e(asset('pwd')); ?>">PWD</a></h4>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"><a href="<?php echo e(asset('etender')); ?>"> <img src="images/service/etender.jpg" class="img-circle htw" alt="tender" /></a>
          <h4><a href="<?php echo e(asset('etender')); ?>">E-Tender</a></h4>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(asset('dsignature')); ?>"><img src="images/service/dsignature.jpg" class="img-circle htw" alt="digital Signature" /></a>
          <h4><a href="<?php echo e(asset('dsignature')); ?>">Digital Signature</a></h4>
          <p>A digital signature is a mathematical scheme for verifying the authenticity of digital messages or documents..</p>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"><a href="<?php echo e(asset('epf')); ?>"> <img src="images/service/epf.png" class="img-circle htw" alt="EPF" /></a>
          <h4><a href="<?php echo e(asset('epf')); ?>">EPF</a></h4>
          <p>The Employee Provident Fund is the retirement saving scheme available to all the salaried employees.</p>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(asset('gumasta')); ?>"><img src="images/service/gumasta.png" class="img-circle htw" alt="gumasta" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(asset('esic')); ?>"><img src="images/service/ESIC.jpg" class="img-circle htw" alt="ESIC" /></a>
          <h4><a href="<?php echo e(asset('esic')); ?>">ESIC</a></h4>
          <p>Employees' State Insurance is a self-financing social security and health insurance scheme for Indian workers.</p>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(asset('gst')); ?>"><img src="images/service/gst.jpg" class="img-circle htw" alt="GST" /></a>
          <h4><a href="<?php echo e(asset('gst')); ?>">GST</a></h4>
          <p>Goods and Services Tax (GST) is an indirect tax (or consumption tax) used in India on the supply of goods and services.</p>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(asset('msme')); ?>"><img src="images/service/msme.jpg"  class="img-circle htw" alt="MSME" /></a>
          <h4><a href="<?php echo e(asset('msme')); ?>">MSME</a></h4>
