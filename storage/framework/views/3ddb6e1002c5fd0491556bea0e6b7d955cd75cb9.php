...
<style>
    textarea {
                                        ...
                                        <?php echo e(Form::model($service, array('route' => array('service2.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-7 text-center" data-aos="fade-up">
            ...
            <p class="font-size-lg text-muted mb-6 mb-md-8">
              <textarea name="d2" style="width:500px;  height:150px; "><?php echo e(old('d2')?old('d2'):$d2); ?></textarea>
            </p>

            <!-- Button -->
            <a  class="btn btn-primary mr-1 lift">
              <input type="text" name="d3" id="d3" value="<?php echo e(old('d3')?old('d3'):$d3); ?>" /> <i class="fe fe-arrow-right ml-3"></i>
            </a>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="50">
            ...
            <div class="card shadow-light-lg mb-6 mb-md-0 lift lift-lg">
              <div class="card-body">
                ...
                <!-- Text -->
                <p class="text-muted">
                  <textarea name="d7" style="width:150px;  height:150px;"><?php echo e(old('d7')?old('d7'):$d7); ?></textarea>
                </p>

                <!-- Link -->
                <a  class="font-size-sm font-weight-bold text-decoration-none">
                  <input type="text" name="d8" id="d8" value="<?php echo e(old('d8')?old('d8'):$d8); ?>" /> <i class="fe fe-arrow-right ml-3"></i>
                </a>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="card shadow-light-lg mb-6 mb-md-0 lift lift-lg">
              <div class="card-body">
                ...
                <!-- Text -->
                <p class="text-muted">
                  <textarea name="d11" id="d11" style="width:150px;  height:150px;"><?php echo e(old('d11')?old('d11'):$d11); ?></textarea>
                </p>

                <!-- Link -->
                <a href="#!" class="font-size-sm font-weight-bold text-decoration-none">
                  <input type="text" name="d12" id="d12" value="<?php echo e(old('d12')?old('d12'):$d12); ?>" /> <i class="fe fe-arrow-right ml-3"></i>
                </a>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="150">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              <div class="card-body">
                ...
                <!-- Text -->
                <p class="text-muted">
                  <textarea name="d15" style="width:150px;  height:150px; "><?php echo e(old('d15')?old('d15'):$d15); ?></textarea>
                </p>

                <!-- Link -->
                <a href="#!" class="font-size-sm font-weight-bold text-decoration-none">
                  <input type="text" name="d16" id="d14" value="<?php echo e(old('d16')?old('d16'):$d16); ?>" /> <i class="fe fe-arrow-right ml-3"></i>
                </a>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <p class="font-size-lg text-muted mb-7">
              <textarea name="d19" style="width:150px;  height:150px; "><?php echo e(old('d19')?old('d19'):$d19); ?></textarea>
            </p>
          ...
          <div class="col-12 order-md-2">
           ...
           <!--  <div class="device-combo device-combo-macbook-iphonex mb-6 mb-md-0" -->>
              ...
              <!-- <div class="device device-macbook">
                ...
                <img src="<?php echo e(asset ('assets/ui/img/devices/mackbook.jpg')); ?>" class="img-fluid" alt="...">
              </div> -->
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <p class="font-size-lg text-muted mb-7 mb-md-9">
             <textarea name="d28" style="width:300px;  height:150px; "><?php echo e(old('d28')?old('d28'):$d28); ?></textarea>
            </p>
        ...
        <div class="row no-gutters mb-7 mb-md-9">
          <div class="col-12 col-md-4 text-center">
            ...
            <p class="text-muted mb-6 mb-md-0">
              <textarea name="d31" style="width:300px;  height:150px; "><?php echo e(old('d31')?old('d31'):$d31); ?></textarea>
          ...
          <div class="col-12 col-md-4 text-center">
            ...
            <!-- Headin -->
            <h3 class="font-weight-bold">
              <input type="text" name="d32" id="d32" value="<?php echo e(old('d32')?old('d32'):$d32); ?>" />
            </h3>

            <!-- Text -->
            <p class="text-muted mb-6 mb-md-0">
              <textarea name="d34" style="width:300px;  height:150px; "><?php echo e(old('d34')?old('d34'):$d34); ?></textarea>
          ...
          <div class="col-12 col-md-4 text-center">
            ...
            <p class="text-muted mb-0">
              <textarea name="d37" style="width:300px;  height:150px; "><?php echo e(old('d37')?old('d37'):$d37); ?></textarea>
            </p>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <h6 class="text-uppercase text-success font-weight-bold">
              <input type="text" name="d64" id="d64" value="<?php echo e(old('d64')?old('d64'):$d64); ?>" />
            </h6>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md">
            ...
            <h3 class="font-weight-bold mb-1">
              <input type="text" name="d58" id="d58" value="<?php echo e(old('d58')?old('d58'):$d58); ?>" />
            </h3>
          ...
          <div class="col-12 col-md-auto">
            ...
            <input type="text" name="d61" id="d61" value="<?php echo e(old('d61')?old('d61'):$d61); ?>" />
            
            <a  class="btn btn-primary lift">
              <input type="text" name="d62" id="d62" value="<?php echo e(old('d62')?old('d62'):$d62); ?>" />
            </a>
            <input type="text" name="d63" id="d63" value="<?php echo e(old('d63')?old('d63'):$d63); ?>" />
