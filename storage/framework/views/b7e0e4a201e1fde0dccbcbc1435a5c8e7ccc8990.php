        ...
        <div class="row justify-content-between">
          <div class="col-12 col-md">
            ...
            <blockquote class="blockquote mb-8 mb-md-0">
              ...
              <!-- Logo -->
              <div class="img-fluid mb-5 mb-md-6 svg-shim" style="max-width: 120px; color: #FF5A5F;">
              ...
              <p class="lead text-gray-700 mb-5 mb-md-7">
                <textarea name="d7" style="height:150px; width:300px" ><?php echo e(old('d7')?old('d7'):$d7); ?></textarea>
              </p>
          ...
          <div class="col-12 col-md">
            ...
            <blockquote class="blockquote mb-0">
              ...
              <!-- Logo -->
              <div class="img-fluid mb-5 mb-md-6 svg-shim" style="max-width: 120px; color: #0081C9;">
              ...
              <!-- Text -->
              <p class="lead text-gray-700 mb-5 mb-md-7">
                <textarea name="d10" style="height:150px; width:300px" ><?php echo e(old('d10')?old('d10'):$d10); ?></textarea> 
              </p>
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6">
            ...
            <div class="img-skewed img-skewed-right mb-10 mb-md-0">
              <img src="<?php echo e(asset ('assets/ui/img/screenshots/ui/dashkit-layered.png')); ?>" alt="..." class="img-fluid" data-aos="img-skewed-item-right">
            </div>
          ...
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <div class="d-flex">
              ...
              <div class="px-5">
                <h3 class="mb-0">
                    <span data-toggle="countup" data-from="0" data-to="99.99" data-decimals="2" data-aos data-aos-id="countup:in">0.00</span>%
                </h3>
                <p class="text-gray-700 mb-0">
              ...
              <div class="pl-5">
                <h3 class="mb-0">
                    <span data-toggle="countup" data-from="0" data-to="5.0" data-decimals="1" data-aos data-aos-id="countup:in">0.0</span>/5.0
                </h3>
                <p class="text-gray-700 mb-0">
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              <div class="col-6 mt-8 mr-n5" data-aos="fade-up">
                ...
                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-10.jpg')); ?>" alt="..." class="img-fluid mb-4 rounded">

                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-12.jpg')); ?>" alt="..." class="img-fluid rounded">

              </div>
              <div class="col-6" data-aos="fade-up" data-aos-delay="100">
                
                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-9.jpg')); ?>" alt="..." class="img-fluid mb-4 rounded">

                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-11.jpg')); ?>" alt="..." class="img-fluid rounded">
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-12 col-md-6 order-md-1" data-aos="fade-up">
            ...
            <div class="w-100 w-md-130 float-right mb-6 mb-md-0">
              ...
              <!-- Shape -->
              <div class="shape shape-blur-4 svg-shim text-gray-200">
              ...
              <div class="device device-macbook">
                <img src="<?php echo e(asset ('assets/ui/img/screenshots/desktop/dashkit-alt-dark.jpg')); ?>" class="device-screen" alt="...">
