                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text text-right">
                      <!-- <a href="<?php echo e(URL('admin/cart')); ?>">
                        <span id="cortCount" style="background: #a94242;border-radius: 50px;padding: 5px;color: #fff;"><?php echo e($count); ?></span>
                      ...
                      <div class="">
                          <div class="well well-sm" style="min-height: 50px;">
                               ...
                               <form>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                   <input type="submit" value="Search" class="btn btn-success">
                                    <a href="<?php echo e(URL('/admin/place_order')); ?>"  class="btn btn-danger">Reset</a>
                                </div>
                               </form>
                              </div>
                          </div>
                                      ...
                                      <div class="item  col-xs-4 col-lg-4">
                                        <?php if(\Cart::get($product->id)){ ?>
                                         <div class="topright">
                                          ...
                                          <div class="thumbnail">
                                              <img class="group list-group-image" src="<?php echo e(asset($image)); ?>" alt="" style="height: 270px;" />
                                              <div class="caption">
                                                  <h4 class="group inner list-group-item-heading">
                                                    <a href="<?php echo e(URL('admin/updateDetail/'.$product->id)); ?>"> <?php echo e($product->name); ?></a></h4>
                                                  <p class="group inner list-group-item-text">
                                                     <?php echo e($product->short_des); ?></p>
                                                  <div class="row">
                                                      ...
                                                      <div class="col-xs-12 col-md-6">
                                                        <a class="btn btn-success addToCart" style="margin-right: 3px;" pid="<?php echo e($product->id); ?>"  title="Add To Cart"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
                           ...
                           <?php 
                               ...
                               {
                               ?>
                                 <?php echo e($products->appends(['keywords' => $_GET['keywords']])->links()); ?>
