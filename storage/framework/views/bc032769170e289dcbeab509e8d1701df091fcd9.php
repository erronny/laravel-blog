<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="notificationsbtn nav navbar-nav navbar-left">
                <li id="notificationsli">
                  ...
                  <span class="noty-manager-bubble" style="margin-left: -2px; top: 10px; opacity: 1;"><?php echo e(auth()->user()->unreadNotifications()->count()); ?></span></a>
                    ...
                    <div id="notification-container" class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="drop3">
                        ...
                        <section class="panel">
                            ...
                            <div id="notification-list" class="list-group list-group-alt">
                              ...
                              <div style=""><div class="noty-manager-list-item noty-manager-list-item-error">
                                ...
                                <div class="activity-item"> <i class="fa fa-bell text-success"></i> 
                                    <div class="activity"> <a href="<?php echo e(URL('admin/notifications')); ?>"> New User <?php echo e($not->data['data']); ?> Registered</a> <span><?php echo e($not->created_at); ?></span> </div> 
                                </div>
                            ...
                            <footer class="panel-footer">
                                <a href="<?php echo e(URL('admin/notifications')); ?>" class="pull-right"><i class="fa fa-cog"></i></a>
                                <a href="<?php echo e(URL('admin/notifications')); ?>" data-toggle="class:show animated fadeInRight">See all the notifications</a>
                            </footer>
                        </section>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="<?php echo URL('/'); ?>/admin/websitesetting">Settings</a>
                        <a class="dropdown-item" href="<?php echo e(URL('admin/profile')); ?>">Security</a>
