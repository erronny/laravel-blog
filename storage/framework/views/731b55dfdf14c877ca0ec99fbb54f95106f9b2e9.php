...
<style>
    textarea {
                                        ...
                                        <?php echo e(Form::model($service, array('route' => array('service7.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
                                        ...
                                        ?>
                                        <?php else: ?>
                                        <?php echo e(Form::open(array('url' => 'admin/service2','enctype'=>'multipart/form-data','autocomplete'=>"off"))); ?>
...
<!-- NAVBAR
   ...
   <section data-jarallax data-speed=".8" class="pt-10 pt-md-14 pb-12 pb-md-15 overlay overlay-primary overlay-80 jarallax" style="background-image: url(assets/ui/img/covers/cover-6.jpg);">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 text-center">
            ...
            <!-- Button -->
            <a  class="btn btn-pill btn-white shadow " data-fancybox>
              <i class="fe fe-eye mr-2"></i>
              <input type="text" name="d1" id="d1" value="<?php echo e(old('d1')?old('d1'):$d1); ?>" />
            </a></br>
            <p>Link<input type="text" name="d2" id="d2" value="<?php echo e(old('d2')?old('d2'):$d2); ?>" /></p>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d3" id="d3" value="<?php echo e(old('d3')?old('d3'):$d3); ?>" /></span>
            </span>

            <!-- Heading -->
            <h1>
              <input type="text" name="d4" id="d4" value="<?php echo e(old('d4')?old('d4'):$d4); ?>" /> <span class="text-primary"><input type="text" name="d5" id="d5" value="<?php echo e(old('d5')?old('d5'):$d5); ?>" /></span>
            </h1>

            <!-- Text -->
            <p class="lead text-gray-700 mb-7 mb-md-9">
              <textarea name="d6" style="height:150px; width:200px" ><?php echo e(old('d6')?old('d6'):$d6); ?></textarea>
            </p>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6 col-lg-7">
            ...
            <div class="mb-8 mb-md-0">
              ...
              <!-- Image -->
              <img src="<?php echo e(asset ('assets/ui/img/screenshots/desktop/rental.jpg')); ?>" alt="..." class="screenshot img-fluid mw-md-110 float-right mr-md-6 mb-6 mb-md-0">
            ...
            <div class="d-flex">
              ...
              <div class="ml-5">
                ...
                <p class="text-gray-700 mb-6">
                  <textarea name="d8" style="height:150px; width:200px" ><?php echo e(old('d8')?old('d8'):$d8); ?></textarea>
                </p>
            ...
            <div class="d-flex">
              ...
              <div class="ml-5">
                ...
                <p class="text-gray-700 mb-0">
                  <textarea name="d12" style="height:150px; width:200px" ><?php echo e(old('d12')?old('d12'):$d12); ?></textarea>
                </p>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-6">
            ...
            <!-- Heading -->
            <h2>
              <input type="text" name="d14" id="d14" value="<?php echo e(old('d14')?old('d14'):$d14); ?>" /> <br>
              <span class="text-primary"><input type="text" name="d15" id="d15" value="<?php echo e(old('d15')?old('d15'):$d15); ?>" /></span>.
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-gray-700 mb-6">
              <textarea name="d16" style="height:150px; width:400px" ><?php echo e(old('d16')?old('d16'):$d16); ?></textarea>
            </p>
            ...
            <div class="row">
              <div class="col-12 col-lg-6">
                ...
                <div class="d-flex">
                  ...
                  <!-- Text -->
                  <p>
                    <input type="text" name="d17" id="d17" value="<?php echo e(old('d17')?old('d17'):$d17); ?>" />
                  </p>
          ...
          <div class="col-12 col-md-6">
            ...
            <!-- Image -->
            <img src="<?php echo e(asset ('assets/ui/img/illustrations/illustration-3.png')); ?>" alt="..." class="img-fluid mw-md-130">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Badge -->
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d21" id="d21" value="<?php echo e(old('d21')?old('d21'):$d21); ?>" /></span>
            </span>
            ...
            <p class="font-size-lg text-muted mb-7 mb-md-9">
              <textarea name="d23" style="height:150px; width:200px" ><?php echo e(old('d23')?old('d23'):$d23); ?></textarea>
            </p>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <!-- Card -->
            <div class="card mb-6 mb-lg-0 pt-14 overlay overlay-black overlay-30 bg-cover shadow-light-lg lift lift-lg" style="background-image: url(assets/ui/img/photos/photo-8.jpg);">
              ...
              <a class="card-body mt-auto" href="#!">
                ...
                <p class="mb-0 text-white">
                  <textarea name="d25" style="height:200px; width:200px" ><?php echo e(old('d25')?old('d25'):$d25); ?></textarea>
                </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-7.jpg')); ?>" alt="..." class="img-fluid">
              </a>
              ...
              <a class="card-body">
                ...
                <p class="mb-0 text-muted">
                  <textarea name="d29" style="height:200px; width:200px" ><?php echo e(old('d29')?old('d29'):$d29); ?></textarea>
              ...
              <a class="card-meta" >
                ...
                <p class="h6 text-uppercase text-muted mb-0 ml-auto">
                  <time datetime="2019-05-02"><input type="text" name="d31" id="d31" value="<?php echo e(old('d31')?old('d31'):$d31); ?>" /></time>
                </p>

              </a><p>LINK
              <input type="text" name="d32" id="d32" value="<?php echo e(old('d32')?old('d32'):$d32); ?>" /></p>
          ...
          <div class="col-12 col-lg-4 d-flex">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <a class="card-body my-auto" href="#!">
                ...
                <!-- Text -->
                <p class="mb-0 text-muted">
                  <textarea name="d34" style="height:200px; width:200px" ><?php echo e(old('d34')?old('d34'):$d34); ?></textarea>
                </p>
              ...
              <a class="card-meta" >
                ...
                <!-- Date -->
                <p class="h6 text-uppercase text-muted mb-0 ml-auto">
                  <time datetime="2019-05-02"><input type="text" name="d37" id="d37" value="<?php echo e(old('d37')?old('d37'):$d37); ?>" /></time>
                </p>

              </a><p>LINK
              <input type="text" name="d38" id="d38" value="<?php echo e(old('d38')?old('d38'):$d38); ?>" /></p>
        ...
        <div class="row align-items-stretch">
          <div class="col-12 col-md-5">
            ...
            <blockquote class="blockquote text-center">
              ...
              <!-- Logo -->
              <div class="img-fluid mb-5 mb-md-7 mx-auto svg-shim" style="max-width: 120px; color: #FF5A5F;">
              ...
              <p class="mb-5 mb-md-7">
                <textarea name="d39" style="height:150px; width:200px" ><?php echo e(old('d39')?old('d39'):$d39); ?></textarea>
              </p>

              <!-- Footer -->
              <footer class="blockquote-footer mb-8 mb-md-0">
                <div class="avatar mr-3">
                  <img src="<?php echo e(asset ('assets/ui/img/avatars/avatar-2.jpg')); ?>" class="avatar-img rounded-circle" alt="...">
                </div> <span class="h6 text-uppercase"><input type="text" name="d40" id="d40" value="<?php echo e(old('d40')?old('d40'):$d40); ?>" /></span>
              </footer>
          ...
          <div class="col-12 col-md-5 offset-md-1">
            ...
            <blockquote class="blockquote text-center">
              ...
              <!-- Text -->
              <p class="mb-5 mb-md-7">
                <textarea name="d41" style="height:150px; width:200px" ><?php echo e(old('d41')?old('d41'):$d41); ?></textarea>
              </p>

              <!-- Footer -->
              <footer class="blockquote-footer mb-0">
                <div class="avatar mr-3">
                  <img src="<?php echo e(asset ('assets/ui/img/avatars/avatar-1.jpg')); ?>" class="avatar-img rounded-circle" alt="...">
                </div> <span class="h6 text-uppercase"><input type="text" name="d42" id="d42" value="<?php echo e(old('d42')?old('d42'):$d42); ?>" /></span>
              </footer>
    ...
    <!-- CTA
    ================================================== -->
    <section data-jarallax data-speed=".8" class="py-12 py-md-14 overlay overlay-black overlay-80 jarallax" style="background-image: url(assets/ui/img/covers/cover-8.jpg);">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-1- col-lg-8 text-center">
            ...
            <!-- Heading -->
            <h1 class="text-white">
              <input type="text" name="d43" id="d43" value="<?php echo e(old('d43')?old('d43'):$d43); ?>" />

            </h1>

            <!-- Text -->
            <p class="font-size-lg text-white-80 mb-6 mb-md-8">
              <textarea name="d44" style="height:150px; width:200px" ><?php echo e(old('d44')?old('d44'):$d44); ?></textarea>
            </p>

            <!-- Button -->
            <a  class="btn btn-pill btn-primary lift">
              <input type="text" name="d45" id="d45" value="<?php echo e(old('d45')?old('d45'):$d45); ?>" />
 <i class="fe fe-arrow-right ml-2"></i>
            </a>
            <p>URL<input type="text" name="d46" id="d46" value="<?php echo e(old('d46')?old('d46'):$d46); ?>" />
</p>
