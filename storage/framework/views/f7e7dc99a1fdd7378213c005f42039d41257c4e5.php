...
<?php $__env->startSection('title', 'Organization Combo | Digital In-Corporation'); ?>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Button -->
            <a href="<?php echo e($service->d4); ?>" class="btn btn-white shadow lift">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6 col-lg-5" data-aos="fade-up">
            ...
            <span class="badge badge-pill badge-success-soft mb-3">
              <span class="h6 text-uppercase"><?php echo e($service->d14); ?></span>
            </span>

            <!-- Heading -->
            <h2 class="font-weight-bold">
              <?php echo e($service->d15); ?> <br>
              <span class="text-success"><?php echo e($service->d16); ?></span>.
            </h2>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Badge -->
            <span class="badge badge-pill badge-success-soft mb-3">
              <span class="h6 text-uppercase"><?php echo e($service->d30); ?></span>
            </span>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Badge -->
            <span class="badge badge-pill badge-success-soft mb-3">
              <span class="h6 text-uppercase"><?php echo e($service->d45); ?></span>
            </span>
