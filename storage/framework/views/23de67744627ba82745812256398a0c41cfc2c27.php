...
<style>
    textarea {
                                        ...
                                        <?php echo e(Form::model($service, array('route' => array('service5.update', $service->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
                                        ...
                                        ?>
                                        <?php else: ?>
                                        <?php echo e(Form::open(array('url' => 'admin/service5','enctype'=>'multipart/form-data','autocomplete'=>"off"))); ?>
...
<!-- NAVBAR
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6 order-md-2">
            ...
            <div class="img-skewed img-skewed-left mb-8 mb-md-0">
              <img src="<?php echo e(asset ('assets/ui/img/screenshots/desktop/dashkit.jpg')); ?>" alt="..." class="screenshot img-fluid mw-md-130" data-aos="img-skewed-item-left" data-aos-delay="100">
            </div>
          ...
          <div class="col-12 col-md-6 order-md-1" data-aos="fade-up">
            ...
            <!-- Heading -->
            <h1 class="display-3">
              <input type="text" name="d" id="d" value="<?php echo e(old('d')?old('d'):$d); ?>" /> <br>
              <span class="text-primary"><input type="text" name="d1" id="d1" value="<?php echo e(old('d1')?old('d1'):$d1); ?>" /></span>.
            </h1>

            <!-- Text -->
            <!-- <p class="lead text-muted mb-6 mb-md-8">
              <textarea name="d2" style="height:200px; width:500px" ><?php echo e(old('d2')?old('d2'):$d2); ?></textarea>
            </p> -->
 ...
 <i class="fe fe-arrow-right ml-3"></i>
            ...
            <input type="text" name="d6" id="d6" value="<?php echo e(old('d6')?old('d6'):$d6); ?>" /></p> -->
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-12 col-md-10 col-lg-10">
            ...
            <!-- Heading -->
            <h2>
              <input type="text" name="d13" id="d13" value="<?php echo e(old('d13')?old('d13'):$d13); ?>" /><br>
              <span class="text-primary"><input type="text" name="d14" id="d14" value="<?php echo e(old('d14')?old('d14'):$d14); ?>" /></span>
            </h2>
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <span class="badge badge-pill badge-success-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d19" id="d19" value="<?php echo e(old('d19')?old('d19'):$d19); ?>" /></span>
            </span>

            <!-- Heading -->
            <h2>
              <input type="text" name="d20" id="d20" value="<?php echo e(old('d20')?old('d20'):$d20); ?>" /> <br>
              <span class="text-success"><input type="text" name="d21" id="d21" value="<?php echo e(old('d21')?old('d21'):$d21); ?>" /></span>.
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-gray-700 mb-6">
              <textarea name="d22" style="height:150px; width:200px" ><?php echo e(old('d22')?old('d22'):$d22); ?></textarea>
            </p>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              <div class="col-6 " data-aos="fade-up">
                ...
                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-10.jpg')); ?>" alt="..." class="rounded">
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6 col-lg-5 order-md-2">
            ...
            <!-- <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d27" id="d27" value="<?php echo e(old('d27')?old('d27'):$d27); ?>" /></span>
            </span> -->

            <!-- Heading -->
            <h2>
              <input type="text" name="d28" id="d28" value="<?php echo e(old('d28')?old('d28'):$d28); ?>" /> <br>
              <span class="text-primary"><input type="text" name="d29" id="d29" value="<?php echo e(old('d29')?old('d29'):$d29); ?>" /></span>.
            </h2>

            <!-- Text -->
            <p class="font-size-lg text-gray-700 mb-8 mb-md-0">
              <textarea name="d30" style="height:150px; width:300px" ><?php echo e(old('d30')?old('d30'):$d30); ?></textarea>
            </p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Heading -->
            <h2>
              <input type="text" name="d32" id="d32" value="<?php echo e(old('d32')?old('d32'):$d32); ?>" /> <span class="text-success"><input type="text" name="d33" id="d33" value="<?php echo e(old('d33')?old('d33'):$d33); ?>" /></span>
            </h2>

            <!-- Text -->
            <p class="lead text-gray-700">
              <textarea name="d34" style="height:150px; width:300px" ><?php echo e(old('d34')?old('d34'):$d34); ?></textarea>
            </p>
            ...
            <form class="d-flex align-items-center justify-content-center mb-7 mb-md-9">
              ...
              <span class="text-muted">
                <input type="text" name="d35" id="d35" value="<?php echo e(old('d35')?old('d35'):$d35); ?>" />
              </span>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <!-- Card -->
            <div class="card card-border card-border-xl border-success shadow-light-lg mb-6 mb-md-0 lift lift-lg">
              <div class="card-body">

                <!-- Badge -->
                <h6 class="font-weight-bold text-uppercase text-center text-success mb-5"><input type="text" name="d37" id="d37" value="<?php echo e(old('d37')?old('d37'):$d37); ?>" /></h6>

                <!-- Price -->
                <!-- <div class="d-flex justify-content-center">
                  <span class="h2 mb-0 mt-2"><input type="text" name="d38" id="d38" value="<?php echo e(old('d38')?old('d38'):$d38); ?>" /></span>
                  <span class="price display-2 mb-0" data-annual="29" data-monthly="49">29</span>
                  <span class="h2 align-self-end mb-1"><input type="text" name="d39" id="d39" value="<?php echo e(old('d39')?old('d39'):$d39); ?>" /></span>
                </div> -->
               ...
               <!--  <div class="d-flex"> -->
                  ...
                  <!-- Text -->
                  <!-- <p class="mb-0">
                    <input type="text" name="d44" id="d44" value="<?php echo e(old('d44')?old('d44'):$d44); ?>" />
                  </p> -->
          ...
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <div class="card card-border card-border-xl border-dark shadow-light-lg lift lift-lg">
              <div class="card-body">
                ...
                <!-- Badge -->
                <h6 class="font-weight-bold text-uppercase text-center mb-5"><input type="text" name="d45" id="d45" value="<?php echo e(old('d45')?old('d45'):$d45); ?>" /></h6>

                <!-- Price -->
                <!-- <div class="d-flex justify-content-center">
                  <span class="h2 mb-0 mt-2"><input type="text" name="d46" id="d46" value="<?php echo e(old('d46')?old('d46'):$d46); ?>" /></span>
                  <span class="price display-2 mb-0" data-annual="49" data-monthly="69">49</span>
                  <span class="h2 align-self-end mb-1"><input type="text" name="d47" id="d47" value="<?php echo e(old('d47')?old('d47'):$d47); ?>" /></span>
                </div> -->
                ...
                <div class="d-flex">
                  ...
                  <p class="mb-0">
                    <input type="text" name="d54" id="d54" value="<?php echo e(old('d54')?old('d54'):$d54); ?>" />
                  </p>
    ...
    <!-- BRANDS
    ================================================== -->
    <section class="py-6 py-md-8 bg-primary-desat">
      <div class="container">
    ...
    <!-- CTA
    ================================================== -->
    <section class="py-10 py-md-14 bg-dark" style="background-image: url(assets/ui/img/patterns/pattern-1.svg);">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <span class="badge badge-pill badge-gray-700-soft mb-3">
              <span class="h6 text-uppercase"><input type="text" name="d55" id="d5" value="<?php echo e(old('d55')?old('d55'):$d55); ?>" /></span>
            </span>
            ...
            <p class="font-size-lg text-muted mb-6 mb-md-8">
                <textarea name="d57" style="height:150px; width:200px" ><?php echo e(old('d57')?old('d57'):$d57); ?></textarea>
            </p>

            <!-- Button -->
            <a  class="btn btn-primary-desat lift">
              <input type="text" name="d58" id="d58" value="<?php echo e(old('d58')?old('d58'):$d58); ?>" /> <i class="fe fe-arrow-right ml-2"></i>
            </a><p>URL
            <input type="text" name="d59" id="d59" value="<?php echo e(old('d59')?old('d59'):$d59); ?>" /></p>
