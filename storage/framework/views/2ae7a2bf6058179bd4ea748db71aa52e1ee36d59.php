                            ...
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    ...
                                    <div class="col-sm-6 text text-right">
                                      <a href="<?php echo e(URL("admin/contractor")); ?>">List</a>
                                    </div>
                                </div>
                            </div>
                            <div class="sparkline12-graph">
                                <div class="basic-login-form-ad">
                                    <div class="row">
                                        ...
                                        <?php echo e(Form::model($tender, array('route' => array('contractor.update', $tender->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
                                        ...
                                        ?>
                                        <?php else: ?>
                                        <?php echo e(Form::open(array('url' => 'admin/contractor','enctype'=>'multipart/form-data','autocomplete'=>"off"))); ?>
