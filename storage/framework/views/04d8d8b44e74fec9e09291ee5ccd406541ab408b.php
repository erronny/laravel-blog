		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6">
					<h3>What we are</h3>
					<div class="margin-bottom-30"></div>
					<p>LakeACR is an IT company which was founded by young entrepreneurs & professionals. LakeACR has extended network  over central india in the very short span of time and is one of fastest growing IT industry.</p>
					<ul class="bull">
						
						<li>Provide IT services to a diverse customer base across multiple sectors</li>
						<li>Remain responsive to our customers’ needs</li>
						<!--<li>Work fewer hours — and make more money</li>-->
					</ul>
					<div class="spacer-30"></div>
					<a href="<?php echo e(URL('servicess')); ?>" class="btn btn-primary">Our Services</a>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6">
					<div class="vidimg">
						<div class="play-vid">
							<a class="popup-youtube" href="https://www.youtube.com/watch?v=SsQHAGluOO4"><span class="fa fa-play fa-3x playvid"></span></a>
						</div>
				...
				<div class="col-sm-6 col-md-6">
					...
					<div class="box-icon-6 layout-2">
		              ...
		              <div class="infobox">
		                ...
		                <div class="text">the capacity to envisage future market trends and plan accordingly. We create sites using HTML & CSS &amp;</div>
		              </div>
		            </div>
			...
			<div class="row gutter-20">
				...
				<div class="col-sm-4 col-md-4">
					...
					<div class="body-content">
							...
							Office Telephone: +91 8871224770 <br>
