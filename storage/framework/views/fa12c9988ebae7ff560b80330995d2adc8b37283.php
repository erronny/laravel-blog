...
<!--Page Title Section Satrt-->
  ...
  <section id="service_page">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(URL('pan')); ?>"><img src="<?php echo e(asset('assets/dsolution/images/service/pan.png')); ?>" class="img-circle htw" alt="pan card" style="color:white"/></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img active"> <a href="<?php echo e(URL('pwd')); ?>"><img src="<?php echo e(asset('assets/dsolution/images/service/PWD.png')); ?>" class="img-circle htw" alt="pwd" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"><a href="<?php echo e(URL('etender')); ?>"> <img src="<?php echo e(asset('assets/dsolution/images/service/etender.jpg')); ?>" class="img-circle htw" alt="tender" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(URL('dsignature')); ?>"><img src="<?php echo e(asset('assets/dsolution/images/service/dsignature.jpg')); ?>" class="img-circle htw" alt="digital Signature" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"><a href="<?php echo e(URL('epf')); ?>"> <img src="<?php echo e(asset('assets/dsolution/images/service/epf.png')); ?>" class="img-circle htw" alt="EPF" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(asset('gumasta')); ?>"><img src="<?php echo e(asset('assets/dsolution/images/service/gumasta.png')); ?>" class="img-circle htw" alt="gumasta" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(URL('esic')); ?>"><img src="<?php echo e(asset('assets/dsolution/images/service/ESIC.jpg')); ?>" class="img-circle htw" alt="ESIC" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(URL('gst')); ?>"><img src="<?php echo e(asset('assets/dsolution/images/service/gst.jpg')); ?>" class="img-circle htw" alt="GST" /></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 srevice_img"> <a href="<?php echo e(URL('msme')); ?>"><img src="<?php echo e(asset('assets/dsolution/images/service/msme.jpg')); ?>"  class="img-circle htw" alt="MSME" /></a>
