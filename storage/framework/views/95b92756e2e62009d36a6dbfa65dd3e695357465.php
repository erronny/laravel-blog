      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 text-center">
            ...
            <!-- Button -->
            <a href="<?php echo e($service->d2); ?>" class="btn btn-pill btn-white shadow lift" data-fancybox>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><?php echo e($service->d3); ?></span>
            </span>

            <!-- Heading -->
            <h1>
              <?php echo e($service->d4); ?> <span class="text-primary"><?php echo e($service->d5); ?></span>
            </h1>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-6">
            ...
            <!-- Heading -->
            <h2>
              <?php echo e($service->d14); ?> <br>
              <span class="text-primary"><?php echo e($service->d15); ?></span>.
            </h2>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Badge -->
            <span class="badge badge-pill badge-primary-soft mb-3">
              <span class="h6 text-uppercase"><?php echo e($service->d21); ?></span>
            </span>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 pt-14 overlay overlay-black overlay-30 bg-cover shadow-light-lg lift lift-lg" style="background-image: url(assets/ui/img/photos/photo-8.jpg);">
              ...
              <!-- Meta -->
              <a class="card-meta" href="<?php echo e($service->d46); ?>">
                ...
                <p class="h6 text-uppercase text-white-80 mb-0 ml-auto">
                  <time datetime="2019-05-02"><?php echo e($service->d27); ?></time>
                </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <!-- Meta -->
              <a class="card-meta" href="<?php echo e($service->d32); ?>">
          ...
          <div class="col-12 col-lg-4 d-flex">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <!-- Meta -->
              <a class="card-meta" href="<?php echo e($service->d38); ?>">
          ...
          <div class="col-12 col-md-5">
            ...
            <blockquote class="blockquote text-center">
              ...
              <footer class="blockquote-footer mb-8 mb-md-0">
                ...
                </div> <span class="h6 text-uppercase"><?php echo e($service->d40); ?></span>
              </footer>
          ...
          <div class="col-12 col-md-5 offset-md-1">
            ...
            <blockquote class="blockquote text-center">
              ...
              <footer class="blockquote-footer mb-0">
                ...
                </div> <span class="h6 text-uppercase"><?php echo e($service->d42); ?></span>
              </footer>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-1- col-lg-8 text-center">
            ...
            <!-- Button -->
            <a href="<?php echo e($service->d46); ?>" class="btn btn-pill btn-primary lift">
              <?php echo e($service->d45); ?> <i class="fe fe-arrow-right ml-2"></i>
            </a>
