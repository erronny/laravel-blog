                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(URL('admin/service')); ?>">Service 1 </a>
                                    <a class="nav-link" href="<?php echo e(URL('admin/service2')); ?>">Service 2</a>
                                    <a class="nav-link" href="<?php echo e(URL('admin/service3')); ?>">Service 3</a>
                                    <a class="nav-link" href="<?php echo e(URL('admin/service4')); ?>">Service 4</a>
                                    <a class="nav-link" href="<?php echo e(URL('admin/service5')); ?>">Service 5</a>
                                    <a class="nav-link" href="<?php echo e(URL('admin/service6')); ?>">Service 6</a>
                                    <a class="nav-link" href="<?php echo e(URL('admin/service7')); ?>">Service 7</a>
