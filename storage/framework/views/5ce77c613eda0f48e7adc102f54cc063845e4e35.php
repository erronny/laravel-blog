                    ...
                    <div class="dropdown-body">
                      <div class="row no-gutters">
                        ...
                        <div class="col-6">
                          ...
                          <!-- List -->
                          <a class="dropdown-item" href="<?php echo e(URL('/class3-invidual-signing')); ?>">
                            Individual Signing
                          </a>
                  ...
                  <div class="col-6">
                    <div class="row no-gutters">
                      ...
                      <div class="col-12 col-lg-8">
                        ...
                        <!-- List -->
                        <a class="dropdown-item" href="<?php echo e(URL('/e-tender')); ?>">
                          E-Tenders
                        </a>
                        <a class="dropdown-item" href="<?php echo e(URL('/dgft')); ?>">
                          DGFT 
                        </a>
                        <a class="dropdown-item" href="<?php echo e(URL('/')); ?>">
                          Foreign Trade
                        </a>
                        <a class="dropdown-item" href="<?php echo e(URL('/gst')); ?>">
                          GST Registration
                        </a>
                        <a class="dropdown-item" href="<?php echo e(URL('/')); ?>">
                          ICEGATE
