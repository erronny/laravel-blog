                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                       ...
                       <li class="active">
                         ...
                         <li class="active">
                            <a title="Landing Page" href="<?php echo e(URL('admin/tender')); ?>" aria-expanded="false"><i class="fa fa-bookmark icon-wrap sub-icon-mg" aria-hidden="true"></i> <span class="mini-click-non">Contractor</span></a>
                        </li>
