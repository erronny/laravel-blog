      ...
      <div class="container">
        <div class="row align-items-center text-center text-md-left">
          <div class="col-12 col-md-6">
            ...
            <!-- Image -->
            <img src="<?php echo e(asset ('assets/ui/img/illustrations/illustration.png')); ?>" alt="..." class="img-fluid mw-130 float-right mb-6 mb-md-0" data-aos="fade-right"><a class="dropdown-item" data-toggle="modal">
