              ...
              <div class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col">
                        ...
                        <!-- Heading -->
                        <p class="mb-0">
                           <i class="fa fa-bell text-success"></i>New User <a href="<?php echo e(URL('admin/users')); ?>"><?php echo e($notification->data['email']); ?></a>
                        </p>

                        <!-- Text -->
                        <small class="text-gray-700">
                          Registered <?php echo e($notification->created_at); ?>
