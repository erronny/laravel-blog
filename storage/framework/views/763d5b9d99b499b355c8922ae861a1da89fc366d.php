        ...
        <div class="col-md-8  col-sm-12 col-xs-12 col-sm-12">
          <nav class="navbar"> 
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img class="logo-dark hidden-xs" height="70" width="100" src="<?php echo e(asset('img/1111.jpeg')); ?>" alt="" /> <img class="logo-dark hidden-lg hidden-md hidden-sm" height="40" width="70" src="<?php echo e(asset('img/11112.jpg')); ?>" alt="" /></a> </div>
            ...
            <div class="main-menu collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<?php echo e(asset('service')); ?>">Service</a></li>
                <li><a href="<?php echo e(asset('blog')); ?>">Blog</a></li>
