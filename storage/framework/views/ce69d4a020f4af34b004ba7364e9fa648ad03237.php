...
<!-- Mirrored from rudhisasmito.com/demo/walls/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2017 19:00:55 GMT -->
<head>
    <!-- Basic Page Needs
    ================================================== -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="header header-1">
		...
		<!--					We help the world growing since 2017-->
		<!--					</div>-->
		<!--				</div>-->
		<!--			</div>-->
		...
		<!--						<li><a href="news1.html" title="News">News</a></li>-->
		<!--					</ul>-->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<ol class="breadcrumb">
						<li><a href="<?php echo e(URL('index')); ?>">Index</a></li>
...
<div class="section">
			...
			<div class="row">
				<div class="col-sm-3 col-md-3">
					<div class="widget info-detail">
						...
						<dl>
							...
							<dd>demo</dd>
							<dt>Location:</dt>
							<dd>NH-12 hosangabad road Vidhyanagar Bhopal(MP) INDIA</dd>
							<dt>Completed:</dt>
							<dd>March, 2017</dd>
						</dl>
					</div>
					...
					<div class="widget contact-info-sidebar">
						...
						<ul class="list-info">
							<li>
								...
								<div class="info-text">NH-12 hosangabad road Vidhyanagar Bhopal(MP) INDIA</div> </li>
							<li>
								<div class="info-icon">
				...
				<div class="col-sm-9 col-md-9">
					<div class="single-page">
						...
						<img src="images/software.jpg" alt="" class="img-responsive"> 
						...
						<ul class="checklist">
							<li>100% Secure, yours Website</li>
	...
	<!-- JS VENDOR -->
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/jquery.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/bootstrap.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/jquery.superslides.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/owl.carousel.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/bootstrap-hover-dropdown.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/jquery.magnific-popup.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/easings.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/isotope.pkgd.min.js')); ?>"></script>

    <!-- sendmail -->
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/validator.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/vendor/form-scripts.js')); ?>"></script>
