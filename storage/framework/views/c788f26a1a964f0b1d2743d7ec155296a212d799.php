<?php $__env->startSection('title', 'service4 | Digital In-Corporation'); ?>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <p class="mb-7 mb-md-9" data-aos="fade-up" data-aos-delay="150">
              <a class="btn btn-primary shadow lift" href="<?php echo e($service->d4); ?>">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Preheading -->
            <h6 class="text-uppercase text-warning"><?php echo e($service->d25); ?></h6>
