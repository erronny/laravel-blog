                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                          ...
                                                          <div class="col-sm-6">
                                                                  ...
                                                                  <input class="form-control" name="WorkDescription" value="<?php echo e(old('WorkDescription')?old('WorkDescription'):$WorkDescription); ?>"placeholder="Enter Work Detail" />
                                                          ...
                                                          <div class="col-sm-6">
                                                                  ...
                                                                  <input class="form-control" name="department" value="<?php echo e(old('department')?old('department'):$department); ?>"placeholder="Enter Department" />
                                                                  <?php if($errors->has('department')): ?>
                                                                    <div class="text text-danger"><?php echo e($errors->first('department')); ?></div>
                                                                  <?php endif; ?>
                                                          </div>
                                                          ...
                                                          <div class="col-sm-6">
                                                                  ...
                                                                  <input class="form-control" name="trn" value="<?php echo e(old('trn')?old('trn'):$trn); ?>"placeholder="Enter Tender Referene Number" />
                                                                  <?php if($errors->has('trn')): ?>
                                                                    <div class="text text-danger"><?php echo e($errors->first('trn')); ?></div>
                                                                  <?php endif; ?>
                                                          </div>
                                                          ...
                                                          <div class="col-sm-6">
                                                                  ...
                                                                  <input class="form-control" name="location" value="<?php echo e(old('location')?old('location'):$location); ?>"placeholder="Enter Location" />
                                                                  <?php if($errors->has('location')): ?>
                                                                    <div class="text text-danger"><?php echo e($errors->first('location')); ?></div>
                                                                  <?php endif; ?>
                                                          </div>
                                                          ...
                                                          <div class="col-sm-6">
                                                                  ...
                                                                  <input class="form-control" name="product_category" value="<?php echo e(old('product_category')?old('product_category'):$product_category); ?>"placeholder="Enter product category" />
                                                                  <?php if($errors->has('product_category')): ?>
                                                                    <div class="text text-danger"><?php echo e($errors->first('product_category')); ?></div>
                                                                  <?php endif; ?>
                                                          </div>
                                                          ...
                                                          <div class="col-sm-6">
                                                                  ...
                                                                  <input class="form-control" name="keawords" value="<?php echo e(old('keawords')?old('keawords'):$keawords); ?>"placeholder="Enter Keawords" />
                                                                  <?php if($errors->has('keawords')): ?>
                                                                    <div class="text text-danger"><?php echo e($errors->first('keawords')); ?></div>
                                                                  <?php endif; ?>
                                                          </div>
