...
<div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md">
            ...
            <!-- Link -->
            <a href="<?php echo e(URL ('/admin/pages')); ?>" class="font-weight-bold font-size-sm text-decoration-none mb-3">
          ...
          <div class="col-auto">
            ...
            <a href="<?php echo e(URL ('/admin/dashboard')); ?>" class="btn btn-primary">
              Dashboard
            </a>
            ...
            <div class="collapse d-lg-block" id="sidenavCollapse">
              <div class="">
                ...
                <h6 class="text-uppercase font-weight-bold">
                  <label class="pull-right-pro">Update Page<span class="required">*</span></label>
                </h6>

                <div class="panel-body">
                        <?php echo e(Form::model($pages, array('route' => array('pages.update', $pages->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
