<?php $__env->startSection('title', 'Document Signer | Digital In-Corporation'); ?>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-15.jpg')); ?>" alt="..." class="card-img-top">
              ...
              <a class="card-meta mt-auto" href="#!">
                ...
                <div class="avatar avatar-sm mr-2">
                  <img src="<?php echo e(asset ('assets/ui/img/avatars/avatar-1.jpg')); ?>" alt="..." class="avatar-img rounded-circle">
                </div>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-14.jpg')); ?>" alt="..." class="card-img-top">
              ...
              <a class="card-meta mt-auto" href="#!">
                ...
                <!-- Avatar -->
                <div class="avatar avatar-sm mr-2">
                  <img src="<?php echo e(asset ('assets/ui/img/avatars/avatar-2.jpg')); ?>" alt="..." class="avatar-img rounded-circle">
                </div>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="<?php echo e(asset ('assets/ui/img/photos/photo-7.jpg')); ?>" alt="..." class="card-img-top">
