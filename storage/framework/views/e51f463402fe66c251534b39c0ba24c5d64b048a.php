<?php $__env->startSection('content'); ?>
 ...
 <!-- <section data-jarallax data-speed=".8" class="py-12 py-md-15 bg-cover overlay-dark" style="background-image: url(assets/ui/img/tender_banner.jpg);"></section>
 -->
    <!-- WELCOME
    ================================================== -->
    <section data-jarallax data-speed=".8" class="d-none pt-8 pt-md-12 pb-10 pb-md-14 overlay overlay-black overlay-60 bg-cover jarallax" style="background-image: url(assets/img/covers/cover-13.jpg);">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-7 text-center">
            ...
            <p class="lead text-white-75 mb-0">
              We design & build products, apps, and sites for companies doing good things for the
              planet.
            </p>
          </div>
        </div>
    ...
    <!-- WELCOME
    ================================================== -->
    <section data-jarallax data-speed=".8" class="d-none pt-8 pt-md-12 pb-10 pb-md-14 bg-dark">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-7 text-center">
            <!-- Headin -->
          ...
          <div class="col-12 col-lg-12 col-xl-11">
            ...
            <figure class="figure mb-0">
              ...
              <div class="figure-img" data-flickity='{"wrapAround": true, "pageDots": false, "imagesLoaded": true, "adaptiveHeight": true}'>
                <div class="w-100">
                  <img src="<?php echo e(asset ('assets/ui/img/portfolio/portfolio-cover-3.jpg')); ?>" alt="..." class="img-fluid rounded" />
                </div>
                <div class="w-100">
                  <img src="<?php echo e(asset ('assets/ui/img/portfolio/portfolio-cover-4.jpg')); ?>" alt="..." class="img-fluid rounded" />
                </div>
                <div class="w-100">
                  <img src="<?php echo e(asset ('assets/ui/img/portfolio/portfolio-cover-5.jpg')); ?>" alt="..." class="img-fluid rounded" />
                </div>
              </div>
