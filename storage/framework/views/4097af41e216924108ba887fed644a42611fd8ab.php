      ...
      <div class="container">
        <div class="row align-items-center text-center text-md-left">
          <div class="col-12 col-md-6">
            ...
            <!-- Image -->
            <img src="<?php echo e(asset ('assets/ui/img/illustrations/illustration-4.png')); ?>" alt="..." class="img-fluid mw-130 float-right mb-6 mb-md-0" data-aos="fade-right">
          ...
          <div class="col-12 col-md-6">
            ...
            <h1 class="display-1 font-weight-bold">
              <div data-aos="fade-left"><?php echo e($service->d); ?></div>
              <div data-aos="fade-left" data-aos-delay="100"><?php echo e($service->d1); ?></div>
            </h1>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #FF5A5F;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e($service->d21); ?>" style="color: #FF5A5F;"><?php echo e($service->d20); ?></a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #B81D24;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e($service->d24); ?>" style="color: #B81D24;"><?php echo e($service->d23); ?></a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #0081C9;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e($service->d27); ?>" style="color: #0081C9;">R<?php echo e($service->d26); ?></a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #6772E5;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e($service->d30); ?>" style="color: #6772E5;"><?php echo e($service->d29); ?></a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #CB2027;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e($service->d33); ?>" style="color: #CB2027;"><?php echo e($service->d32); ?></a>
              ...
              <div class="col-12 col-md-5 col-lg-4">
                ...
                <div class="card card-border shadow-light-lg lift lift-lg" style="border-top-color: #DA5988;">
                  <div class="card-body text-center">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e($service->d36); ?>" style="color: #DA5988;"><?php echo e($service->d35); ?></a>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6">
            ...
            <a href="#!" class="btn btn-primary-desat mb-6 mb-md-0 lift">
              <?php echo e($service->d39); ?> <i class="fe fe-arrow-right ml-3"></i>
            </a>
